...
val ApplicationIllustrator: ImageVector
    get() {
        if (_ApplicationIllustrator != null) {
            return _ApplicationIllustrator!!
        }
        _ApplicationIllustrator = ImageVector.Builder(
            name = "ApplicationIllustrator",
            defaultWidth = 400.dp,
            ...
            addPath(
                fill = Brush.linearGradient(
                    colorStops = arrayOf(
                        0f to Color(0xFFFF7C00),
                        1f to Color(0xFFFFB977)
                    ),
            ...
            addPath(
                fill = Brush.linearGradient(
                    colorStops = arrayOf(
                        0f to Color(0xFF261300),
                        1f to Color(0xFF4E2E0E)
                    ),
            ...
            addPath(
                fill = SolidColor(Color(0xFFFF7C00)),
                strokeLineWidth = 0.73333335f,
                pathData = addPathNodes("m 125.08 168.37 l -5.79 22.0 c -0.15 0.59 -0.37 0.73 -1.1 0.73 h -10.78 c -0.73 0.0 -0.88 -0.22 -0.73 -1.1 l 20.83 -72.89 c 0.37 -1.32 0.59 -2.49 0.73 -6.09 c 0.0 -0.51 0.22 -0.73 0.59 -0.73 h 15.4 c 0.51 0.0 0.73 0.15 0.88 0.73 l 23.32 79.13 c 0.15 0.59 0.0 0.95 -0.59 0.95 h -12.17 c -0.59 0.0 -0.95 -0.15 -1.1 -0.66 l -6.09 -22.07 Z M 145.47 156.49 C 143.42 148.35 138.58 130.6 136.74 122.02 h -0.15 c -1.54 8.58 -5.43 23.1 -8.51 34.47 Z M 178.47 115.71 c 0.0 -4.69 3.3 -7.48 7.48 -7.48 c 4.47 0.0 7.48 3.01 7.48 7.48 c 0.0 4.84 -3.15 7.48 -7.63 7.48 c -4.25 0.0 -7.33 -2.64 -7.33 -7.48 Z M 179.35 132.36 c 0.0 -0.59 0.22 -0.88 0.88 -0.88 h 11.51 c 0.59 0.0 0.88 0.22 0.88 0.88 v 57.86 c 0.0 0.59 -0.15 0.88 -0.88 0.88 L 180.38 191.1 c -0.73 0.0 -0.95 -0.37 -0.95 -0.95 L 179.42 132.36 Z")
            )
            addPath(
                fill = SolidColor(Color(0xFFFF7C00)),
                strokeLineWidth = 0.15833333f,
                pathData = addPathNodes("m 338.19 87.45 l -1.25 4.75 c -0.03 0.13 -0.08 0.16 -0.24 0.16 h -2.33 c -0.16 0.0 -0.19 -0.05 -0.16 -0.24 l 4.5 -15.74 c 0.08 -0.28 0.13 -0.54 0.16 -1.31 c 0.0 -0.11 0.05 -0.16 0.13 -0.16 h 3.33 c 0.11 0.0 0.16 0.03 0.19 0.16 l 5.03 17.08 c 0.03 0.13 0.0 0.21 -0.13 0.21 h -2.63 c -0.13 0.0 -0.21 -0.03 -0.24 -0.14 l -1.31 -4.77 Z M 342.59 84.89 C 342.15 83.13 341.1 79.3 340.71 77.45 h -0.03 c -0.33 1.85 -1.17 4.99 -1.84 7.44 Z M 349.72 76.09 c 0.0 -1.01 0.71 -1.62 1.62 -1.62 c 0.97 0.0 1.62 0.65 1.62 1.62 c 0.0 1.04 -0.68 1.62 -1.65 1.62 c -0.92 0.0 -1.58 -0.57 -1.58 -1.62 Z M 349.91 79.68 c 0.0 -0.13 0.05 -0.19 0.19 -0.19 h 2.49 c 0.13 0.0 0.19 0.05 0.19 0.19 v 12.49 c 0.0 0.13 -0.03 0.19 -0.19 0.19 h -2.45 c -0.16 0.0 -0.21 -0.08 -0.21 -0.21 L 349.92 79.68 Z")
            )
            addPath(
                fill = SolidColor(Color(0xFFFF7C00)),
                strokeLineWidth = 0.1f,
                pathData = addPathNodes("m 332.33 149.55 l -0.79 3.0 c -0.02 0.08 -0.05 0.1 -0.15 0.1 h -1.47 c -0.1 0.0 -0.12 -0.03 -0.1 -0.15 l 2.84 -9.94 c 0.05 -0.18 0.08 -0.34 0.1 -0.83 c 0.0 -0.07 0.03 -0.1 0.08 -0.1 h 2.1 c 0.07 0.0 0.1 0.02 0.12 0.1 l 3.18 10.79 c 0.02 0.08 0.0 0.13 -0.08 0.13 h -1.66 c -0.08 0.0 -0.13 -0.02 -0.15 -0.09 l -0.83 -3.01 Z M 335.11 147.93 c -0.28 -1.11 -0.94 -3.53 -1.19 -4.7 h -0.02 c -0.21 1.17 -0.74 3.15 -1.16 4.7 Z M 339.61 142.37 c 0.0 -0.64 0.45 -1.02 1.02 -1.02 c 0.61 0.0 1.02 0.41 1.02 1.02 c 0.0 0.66 -0.43 1.02 -1.04 1.02 c -0.58 0.0 -1.0 -0.36 -1.0 -1.02 Z M 339.73 144.64 c 0.0 -0.08 0.03 -0.12 0.12 -0.12 h 1.57 c 0.08 0.0 0.12 0.03 0.12 0.12 v 7.89 c 0.0 0.08 -0.02 0.12 -0.12 0.12 h -1.55 c -0.1 0.0 -0.13 -0.05 -0.13 -0.13 v -7.88 Z")
            )
            addPath(
                fill = SolidColor(Color(0xFFFF7C00)),
                strokeLineWidth = 0.075f,
                pathData = addPathNodes("m 329.25 201.16 l -0.59 2.25 c -0.01 0.06 -0.04 0.08 -0.11 0.08 h -1.1 c -0.08 0.0 -0.09 -0.02 -0.08 -0.11 l 2.13 -7.45 c 0.04 -0.14 0.06 -0.25 0.08 -0.62 c 0.0 -0.05 0.02 -0.08 0.06 -0.08 h 1.58 c 0.05 0.0 0.08 0.01 0.09 0.08 l 2.38 8.09 c 0.01 0.06 0.0 0.1 -0.06 0.1 h -1.25 c -0.06 0.0 -0.1 -0.01 -0.11 -0.07 l -0.62 -2.26 Z M 331.33 199.95 c -0.21 -0.83 -0.7 -2.65 -0.89 -3.53 h -0.01 c -0.16 0.88 -0.56 2.36 -0.87 3.53 Z M 334.71 195.78 c 0.0 -0.48 0.34 -0.76 0.76 -0.76 c 0.46 0.0 0.76 0.31 0.76 0.76 c 0.0 0.5 -0.32 0.76 -0.78 0.76 c -0.44 0.0 -0.75 -0.27 -0.75 -0.76 Z M 334.8 197.48 c 0.0 -0.06 0.02 -0.09 0.09 -0.09 h 1.18 c 0.06 0.0 0.09 0.02 0.09 0.09 v 5.92 c 0.0 0.06 -0.01 0.09 -0.09 0.09 h -1.16 c -0.08 0.0 -0.1 -0.04 -0.1 -0.1 v -5.91 Z")
            )
            addPath(
                fill = SolidColor(Color(0xFFFF7C00)),
                strokeLineWidth = 0.05f,
                pathData = addPathNodes("m 326.17 244.93 l -0.4 1.5 c -0.01 0.04 -0.03 0.05 -0.08 0.05 h -0.74 c -0.05 0.0 -0.06 -0.01 -0.05 -0.08 l 1.42 -4.97 c 0.03 -0.09 0.04 -0.17 0.05 -0.41 c 0.0 -0.04 0.01 -0.05 0.04 -0.05 h 1.05 c 0.04 0.0 0.05 0.01 0.06 0.05 l 1.59 5.39 c 0.01 0.04 0.0 0.06 -0.04 0.06 h -0.83 c -0.04 0.0 -0.06 -0.01 -0.08 -0.05 l -0.41 -1.5 Z M 327.56 244.12 c -0.14 -0.56 -0.47 -1.76 -0.6 -2.35 h -0.01 c -0.1 0.58 -0.37 1.58 -0.58 2.35 Z M 329.81 241.34 c 0.0 -0.32 0.22 -0.51 0.51 -0.51 c 0.31 0.0 0.51 0.2 0.51 0.51 c 0.0 0.33 -0.22 0.51 -0.52 0.51 c -0.29 0.0 -0.5 -0.18 -0.5 -0.51 Z M 329.87 242.47 c 0.0 -0.04 0.01 -0.06 0.06 -0.06 h 0.79 c 0.04 0.0 0.06 0.01 0.06 0.06 v 3.94 c 0.0 0.04 -0.01 0.06 -0.06 0.06 h -0.77 c -0.05 0.0 -0.06 -0.03 -0.06 -0.06 v -3.94 Z")
            )
            addPath(
...
private var _ApplicationIllustrator: ImageVector? = null
