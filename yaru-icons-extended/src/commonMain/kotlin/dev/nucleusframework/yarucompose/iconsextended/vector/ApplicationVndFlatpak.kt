...
val ApplicationVndFlatpak: ImageVector
    get() {
        if (_ApplicationVndFlatpak != null) {
            return _ApplicationVndFlatpak!!
        }
        _ApplicationVndFlatpak = ImageVector.Builder(
            name = "ApplicationVndFlatpak",
            defaultWidth = 400.dp,
            ...
            addPath(
                ...
                pathData = addPathNodes("M 152.0 95.46 L 96.0 125.61 L 96.0 128.0 L 96.0 190.39 l 56.0 30.15 l 56.0 -30.15 v -64.78 Z M 152.0 104.54 L 195.56 128.0 L 152.0 151.46 L 108.44 128.0 Z")
            )
            addPath(
                fill = SolidColor(Color.White),
                strokeLineWidth = 1.9999999f,
                pathFillType = PathFillType.EvenOdd,
                pathData = addPathNodes("m 344.0 70.61 l -12.0 6.45 v 0.6 v 13.27 l 12.0 6.45 l 12.0 -6.45 L 356.0 77.06 Z M 344.0 72.88 L 352.89 77.66 L 344.0 82.44 L 335.11 77.66 Z")
            )
            addPath(
                fill = SolidColor(Color.White),
                strokeLineWidth = 1f,
                pathFillType = PathFillType.EvenOdd,
                pathData = addPathNodes("m 336.0 138.99 l -8.0 4.3 v 0.3 v 8.94 l 8.0 4.3 l 8.0 -4.3 v -9.23 Z M 336.0 140.13 L 342.45 143.59 L 336.01 147.04 h -0.03 l -6.43 -3.46 Z")
            )
            addPath(
                fill = SolidColor(Color.White),
                strokeLineWidth = 1f,
                pathFillType = PathFillType.EvenOdd,
                pathData = addPathNodes("m 332.0 193.45 l -6.0 3.22 v 0.3 v 6.63 l 6.0 3.22 l 6.0 -3.22 v -6.93 Z M 332.0 194.58 L 336.44 196.97 L 332.0 199.36 L 327.56 196.97 Z")
            )
            addPath(
                fill = SolidColor(Color.White),
                strokeLineWidth = 1f,
                pathFillType = PathFillType.EvenOdd,
                pathData = addPathNodes("m 328.0 239.91 l -4.0 2.15 v 0.3 v 4.32 l 4.0 2.14 l 4.0 -2.14 v -4.62 Z M 328.0 241.04 L 330.44 242.35 L 328.0 243.66 L 325.56 242.35 Z")
            )
            addPath(
                fill = SolidColor(Color.White),
...
private var _ApplicationVndFlatpak: ImageVector? = null
