...
val ApplicationXBittorrent: ImageVector
    get() {
        if (_ApplicationXBittorrent != null) {
            return _ApplicationXBittorrent!!
        }
        _ApplicationXBittorrent = ImageVector.Builder(
            name = "ApplicationXBittorrent",
            defaultWidth = 400.dp,
            ...
            addPath(
                ...
                strokeLineWidth = 8f,
                pathData = addPathNodes("m 152.0 100.0 c -20.01 0.0 -38.49 10.67 -48.5 28.0 c -10.0 17.33 -10.0 38.67 0.0 56.0 c 10.0 17.33 28.49 28.0 48.5 28.0 h 88.0")
            )
            addPath(
                stroke = SolidColor(Color(0xFF8F76E4)),
                strokeLineWidth = 8f,
                pathData = addPathNodes("m 167.23 119.01 c -14.95 -6.16 -32.14 -2.71 -43.56 8.74 c -11.42 11.45 -14.82 28.64 -8.62 43.58 C 121.25 186.27 135.83 196.0 152.0 196.0 h 88.0")
            )
            addPath(
                stroke = SolidColor(Color(0xFF8F76E4)),
                strokeLineWidth = 8f,
                pathData = addPathNodes("m 168.97 139.03 c -7.68 -7.68 -19.56 -9.25 -28.97 -3.81 c -9.41 5.43 -13.99 16.5 -11.18 27.0 C 131.63 172.7 141.14 180.0 152.0 180.0 h 88.0")
            )
            addPath(
                stroke = SolidColor(Color(0xFF8F76E4)),
                strokeLineWidth = 0.99999994f,
                pathData = addPathNodes("m 331.98 193.5 c -2.14 0.0 -4.11 1.14 -5.18 3.0 c -1.07 1.86 -1.07 4.14 0.0 6.0 c 1.07 1.86 3.04 3.0 5.18 3.0 H 341.0")
            )
            addPath(
                stroke = SolidColor(Color(0xFF8F76E4)),
                strokeLineWidth = 1f,
                pathData = addPathNodes("m 333.51 195.8 c -1.5 -0.62 -3.21 -0.27 -4.36 0.87 c -1.14 1.14 -1.48 2.86 -0.86 4.36 c 0.62 1.49 2.08 2.47 3.69 2.47 H 341.0")
            )
            addPath(
                stroke = SolidColor(Color(0xFF8F76E4)),
                strokeLineWidth = 1f,
                pathData = addPathNodes("m 333.47 198.04 c -0.66 -0.64 -1.67 -0.77 -2.48 -0.32 c -0.81 0.45 -1.2 1.38 -0.96 2.25 c 0.24 0.87 1.05 1.48 1.98 1.48 H 341.0")
            )
            addPath(
                stroke = SolidColor(Color(0xFF8F76E4)),
                strokeLineWidth = 1.9999999f,
                pathData = addPathNodes("m 344.0 73.01 c -3.93 0.0 -7.57 2.1 -9.53 5.5 c -1.97 3.4 -1.97 7.6 0.0 11.0 c 1.97 3.4 5.6 5.5 9.53 5.5 L 362.0 95.0")
            )
            addPath(
                stroke = SolidColor(Color(0xFF8F76E4)),
                strokeLineWidth = 1.9999999f,
                pathData = addPathNodes("m 346.7 77.53 c -2.65 -1.08 -5.69 -0.47 -7.71 1.53 c -2.02 2.0 -2.62 5.01 -1.53 7.63 C 338.56 89.3 341.14 91.0 344.0 91.0 l 18.0 -0.01")
            )
            addPath(
                stroke = SolidColor(Color(0xFF8F76E4)),
                strokeLineWidth = 2f,
                pathData = addPathNodes("m 346.33 81.88 c -1.04 -0.96 -2.65 -1.16 -3.92 -0.48 c -1.27 0.68 -1.89 2.06 -1.51 3.37 c 0.38 1.31 1.67 2.22 3.14 2.22 L 362.0 87.0")
            )
            addPath(
                stroke = SolidColor(Color(0xFF8F76E4)),
                strokeLineWidth = 0.99999994f,
                pathData = addPathNodes("m 336.03 141.5 c -2.48 0.0 -4.76 1.33 -6.0 3.5 c -1.24 2.17 -1.24 4.83 0.0 7.0 c 1.24 2.17 3.53 3.5 6.0 3.5 H 348.0")
            )
            addPath(
                stroke = SolidColor(Color(0xFF8F76E4)),
                strokeLineWidth = 1f,
                pathData = addPathNodes("m 337.88 143.88 c -1.84 -0.77 -3.96 -0.34 -5.36 1.09 c -1.41 1.43 -1.82 3.58 -1.06 5.45 c 0.76 1.87 2.56 3.08 4.55 3.08 H 348.0")
            )
            addPath(
                stroke = SolidColor(Color(0xFF8F76E4)),
                strokeLineWidth = 1f,
                pathData = addPathNodes("m 338.04 146.34 c -0.93 -0.96 -2.37 -1.16 -3.52 -0.48 c -1.14 0.68 -1.7 2.06 -1.36 3.37 c 0.34 1.31 1.5 2.22 2.81 2.22 H 348.0")
            )
            addPath(
                stroke = SolidColor(Color(0xFF8F76E4)),
                strokeLineWidth = 0.99999994f,
                pathData = addPathNodes("m 328.02 240.5 c -1.46 0.0 -2.8 0.76 -3.53 2.0 c -0.73 1.24 -0.73 2.76 0.0 4.0 c 0.73 1.24 2.07 2.0 3.53 2.0 H 334.0")
            )
            addPath(
                stroke = SolidColor(Color(0xFF8F76E4)),
                strokeLineWidth = 0.99999994f,
                pathData = addPathNodes("m 328.89 242.65 c -0.8 -0.31 -1.73 -0.14 -2.34 0.44 c -0.61 0.57 -0.8 1.43 -0.46 2.18 c 0.33 0.75 1.12 1.23 1.98 1.23 H 334.0")
            )
            addPath(
...
private var _ApplicationXBittorrent: ImageVector? = null
