...
val ApplicationXKarbon: ImageVector
    get() {
        if (_ApplicationXKarbon != null) {
            return _ApplicationXKarbon!!
        }
        _ApplicationXKarbon = ImageVector.Builder(
            name = "ApplicationXKarbon",
            defaultWidth = 400.dp,
            ...
            addPath(
                ...
                strokeAlpha = 0.2f,
                strokeLineWidth = 4f,
                pathData = addPathNodes("m 40.0 221.08 c 0.0 35.3 3.63 39.09 38.99 38.92 h 73.01 h 73.01 c 35.37 0.17 38.99 -3.62 38.99 -38.92 V 106.92 c 0.0 -35.3 -3.64 -39.89 -38.99 -38.92 H 152.0 H 78.99 c -35.37 0.0 -38.99 3.62 -38.99 38.92 Z")
            )
            addPath(
                fill = Brush.linearGradient(
                    ...
                    start = Offset(314.65f, 74.67f),
                    end = Offset(371.39f, 104.71f)
                ),
                strokeLineWidth = 0.9766121f,
                pathData = addPathNodes("m 355.99 104.5 c 2.18 0.0 3.89 -0.05 5.3 -0.28 c 1.41 -0.24 2.56 -0.68 3.4 -1.52 c 0.84 -0.84 1.29 -1.99 1.52 -3.39 c 0.24 -1.4 0.29 -3.11 0.29 -5.27 V 75.96 c 0.0 -2.17 -0.05 -3.88 -0.29 -5.28 c -0.24 -1.41 -0.68 -2.55 -1.52 -3.39 c -0.84 -0.84 -1.99 -1.29 -3.4 -1.52 c -1.41 -0.23 -3.12 -0.28 -5.3 -0.27 H 344.0 H 332.02 c -2.18 -0.01 -3.9 0.04 -5.3 0.27 c -1.41 0.23 -2.56 0.68 -3.4 1.52 c -0.84 0.84 -1.29 1.99 -1.52 3.39 c -0.24 1.4 -0.29 3.11 -0.29 5.28 v 18.07 c 0.0 2.17 0.05 3.87 0.29 5.27 c 0.24 1.4 0.68 2.55 1.52 3.39 c 0.84 0.84 1.99 1.28 3.4 1.52 c 1.4 0.23 2.9 0.28 5.3 0.28 H 344.0 Z")
            )
            addPath(
                fill = Brush.linearGradient(
                    colorStops = arrayOf(
            ...
            addPath(
                ...
                strokeAlpha = 0.2f,
                strokeLineWidth = 2f,
                pathData = addPathNodes("m 331.75 65.0 c -2.23 0.0 -3.98 0.05 -5.42 0.29 c -1.44 0.24 -2.62 0.69 -3.48 1.55 c -0.86 0.86 -1.32 2.04 -1.56 3.47 C 321.05 71.76 321.0 73.51 321.0 75.73 v 18.54 c 0.0 2.22 0.05 3.97 0.29 5.41 c 0.24 1.44 0.7 2.62 1.56 3.48 c 0.86 0.86 2.04 1.32 3.48 1.56 c 1.44 0.24 3.19 0.29 5.42 0.28 L 344.0 105.0 L 356.25 105.0 c 2.23 0.01 3.98 -0.04 5.42 -0.28 c 1.44 -0.24 2.62 -0.7 3.48 -1.56 c 0.86 -0.86 1.31 -2.04 1.56 -3.48 C 366.95 98.24 367.0 96.49 367.0 94.27 L 367.0 75.73 c 0.0 -2.22 -0.05 -3.97 -0.29 -5.41 c -0.24 -1.44 -0.7 -2.61 -1.56 -3.47 c -0.86 -0.86 -2.04 -1.31 -3.48 -1.55 C 360.23 65.05 358.48 65.0 356.25 65.0 L 344.0 65.0 Z M 336.75 66.02 c 6.63 -0.0 13.26 0.01 19.88 0.07 c 1.97 0.09 3.96 -0.16 5.86 0.45 c 1.58 0.32 2.78 1.68 3.07 3.23 c 0.5 2.58 0.38 5.2 0.45 7.81 c 0.01 6.55 0.02 13.14 -0.1 19.68 c -0.07 1.81 -0.2 3.88 -1.54 5.24 c -1.32 1.22 -3.22 1.37 -4.94 1.37 c -9.01 0.1 -18.04 0.04 -27.06 0.06 c -1.87 -0.06 -3.74 0.14 -5.58 -0.17 c -1.39 -0.18 -2.88 -0.62 -3.67 -1.87 c -0.98 -1.58 -0.97 -3.54 -1.07 -5.32 c -0.09 -7.56 -0.09 -15.25 -0.01 -22.85 c 0.09 -1.84 0.07 -3.81 1.0 -5.46 c 0.95 -1.59 2.91 -1.94 4.61 -2.09 c 3.03 -0.21 6.06 -0.1 9.1 -0.14 Z")
            )
            addPath(
                fill = SolidColor(Color.Black),
                stroke = SolidColor(Color.Black),
                strokeLineWidth = 2.0674016f,
                pathData = addPathNodes("m 160.44 150.37 c 0.0 9.25 -14.79 18.49 -14.79 29.59 c 0.0 12.95 14.79 18.49 61.03 18.49 v 7.4 c -46.23 0.0 -64.73 -9.25 -64.73 -25.89 c 0.0 -12.95 14.79 -22.19 14.79 -29.59 c 0.0 -5.55 -5.55 -36.99 -61.03 -36.99 c 55.48 0.0 64.73 27.74 64.73 36.99 Z")
            )
            addPath(
                fill = SolidColor(Color.White),
                stroke = SolidColor(Color(0xFF1C399E)),
                strokeLineWidth = 2.865f,
                pathData = addPathNodes("m 226.4 202.15 c 0.0 10.89 -8.83 19.72 -19.72 19.72 c -10.89 0.0 -19.72 -8.83 -19.72 -19.72 c 0.0 -10.89 8.83 -19.72 19.72 -19.72 c 10.89 0.0 19.72 8.83 19.72 19.72 Z")
            )
            addPath(
                fill = SolidColor(Color.White),
                stroke = SolidColor(Color(0xFF1C399E)),
                strokeLineWidth = 2.1888514f,
                pathData = addPathNodes("m 154.76 179.8 c 0.0 5.94 -4.91 10.76 -10.96 10.76 c -6.05 0.0 -10.96 -4.82 -10.96 -10.76 c 0.0 -5.94 4.91 -10.76 10.96 -10.76 c 6.05 0.0 10.96 4.82 10.96 10.76 Z")
            )
            addPath(
                fill = SolidColor(Color.White),
                stroke = SolidColor(Color(0xFF1C399E)),
                strokeLineWidth = 2.5971491f,
                pathData = addPathNodes("m 167.11 143.64 c 0.0 5.74 -4.65 10.39 -10.39 10.39 c -5.74 0.0 -10.39 -4.65 -10.39 -10.39 c 0.0 -5.74 4.65 -10.39 10.39 -10.39 c 5.74 0.0 10.39 4.65 10.39 10.39 Z")
            )
            addPath(
                fill = SolidColor(Color.White),
                stroke = SolidColor(Color(0xFF1C399E)),
                strokeLineWidth = 2.5f,
                pathData = addPathNodes("M 89.24 113.76 a 9.11 9.09 0.0 1 0 18.22 0.0 a 9.11 9.09 0.0 1 0 -18.22 0.0 Z")
            )
            addPath(
                fill = SolidColor(Color.Black),
                stroke = SolidColor(Color.Black),
                strokeLineWidth = 0.4274198f,
                pathData = addPathNodes("m 344.84 82.5 c 0.0 1.91 -3.06 3.82 -3.06 6.12 c 0.0 2.68 3.06 3.82 12.62 3.82 v 1.53 c -9.56 0.0 -13.38 -1.91 -13.38 -5.35 c 0.0 -2.68 3.06 -4.59 3.06 -6.12 c 0.0 -1.15 -1.15 -7.65 -12.62 -7.65 c 11.47 0.0 13.38 5.73 13.38 7.65 Z")
            )
            addPath(
                fill = SolidColor(Color.White),
                stroke = SolidColor(Color(0xFF1C399E)),
                strokeLineWidth = 0.61f,
                pathData = addPathNodes("m 358.48 93.2 c 0.0 2.25 -1.83 4.08 -4.08 4.08 c -2.25 0.0 -4.08 -1.83 -4.08 -4.08 c 0.0 -2.25 1.83 -4.08 4.08 -4.08 c 2.25 0.0 4.08 1.83 4.08 4.08 Z")
            )
            addPath(
                fill = SolidColor(Color.White),
                stroke = SolidColor(Color(0xFF1C399E)),
                strokeLineWidth = 0.4525286f,
                pathData = addPathNodes("m 343.67 88.58 c 0.0 1.23 -1.01 2.22 -2.27 2.22 c -1.25 0.0 -2.27 -1.0 -2.27 -2.22 c 0.0 -1.23 1.01 -2.22 2.27 -2.22 c 1.25 0.0 2.27 1.0 2.27 2.22 Z")
            )
            addPath(
                fill = SolidColor(Color.White),
                stroke = SolidColor(Color(0xFF1C399E)),
                strokeLineWidth = 0.5369412f,
                pathData = addPathNodes("m 346.22 81.11 c 0.0 1.19 -0.96 2.15 -2.15 2.15 c -1.19 0.0 -2.15 -0.96 -2.15 -2.15 c 0.0 -1.19 0.96 -2.15 2.15 -2.15 c 1.19 0.0 2.15 0.96 2.15 2.15 Z")
            )
            addPath(
                fill = SolidColor(Color.White),
                stroke = SolidColor(Color(0xFF1C399E)),
                strokeLineWidth = 0.53656346f,
                pathData = addPathNodes("M 330.12 74.93 a 1.88 1.88 0.0 1 0 3.77 0.0 a 1.88 1.88 0.0 1 0 -3.77 0.0 Z")
            )
            addPath(
                fill = SolidColor(Color.Black),
                stroke = SolidColor(Color.Black),
                strokeLineWidth = 0.28656128f,
                pathData = addPathNodes("m 336.59 147.4 c 0.0 1.28 -2.05 2.56 -2.05 4.1 c 0.0 1.79 2.05 2.56 8.46 2.56 v 1.03 c -6.41 0.0 -8.97 -1.28 -8.97 -3.59 c 0.0 -1.79 2.05 -3.08 2.05 -4.1 c 0.0 -0.77 -0.77 -5.13 -8.46 -5.13 c 7.69 0.0 8.97 3.84 8.97 5.13 Z")
            )
            addPath(
                fill = SolidColor(Color.White),
                stroke = SolidColor(Color(0xFF1C399E)),
                strokeLineWidth = 0.40897116f,
                pathData = addPathNodes("m 345.73 154.58 c 0.0 1.51 -1.22 2.73 -2.73 2.73 c -1.51 0.0 -2.73 -1.22 -2.73 -2.73 c 0.0 -1.51 1.22 -2.73 2.73 -2.73 c 1.51 0.0 2.73 1.22 2.73 2.73 Z")
            )
            addPath(
                fill = SolidColor(Color.White),
                stroke = SolidColor(Color(0xFF1C399E)),
                strokeLineWidth = 0.30339533f,
                pathData = addPathNodes("m 335.8 151.48 c 0.0 0.82 -0.68 1.49 -1.52 1.49 c -0.84 0.0 -1.52 -0.67 -1.52 -1.49 c 0.0 -0.82 0.68 -1.49 1.52 -1.49 c 0.84 0.0 1.52 0.67 1.52 1.49 Z")
            )
            addPath(
                fill = SolidColor(Color.White),
                stroke = SolidColor(Color(0xFF1C399E)),
                strokeLineWidth = 0.35998926f,
                pathData = addPathNodes("m 337.51 146.47 c 0.0 0.8 -0.64 1.44 -1.44 1.44 c -0.8 0.0 -1.44 -0.64 -1.44 -1.44 c 0.0 -0.8 0.64 -1.44 1.44 -1.44 c 0.8 0.0 1.44 0.64 1.44 1.44 Z")
            )
            addPath(
                fill = SolidColor(Color.White),
                stroke = SolidColor(Color(0xFF1C399E)),
                strokeLineWidth = 0.35973603f,
                pathData = addPathNodes("M 326.72 142.33 a 1.26 1.26 0.0 1 0 2.53 0.0 a 1.26 1.26 0.0 1 0 -2.53 0.0 Z")
            )
            addPath(
                fill = SolidColor(Color.Black),
                stroke = SolidColor(Color.Black),
                strokeLineWidth = 0.20959274f,
                pathData = addPathNodes("m 332.71 199.9 c 0.0 0.94 -1.5 1.87 -1.5 3.0 c 0.0 1.31 1.5 1.87 6.19 1.87 v 0.75 c -4.69 0.0 -6.56 -0.94 -6.56 -2.62 c 0.0 -1.31 1.5 -2.25 1.5 -3.0 c 0.0 -0.56 -0.56 -3.75 -6.19 -3.75 c 5.62 0.0 6.56 2.81 6.56 3.75 Z")
            )
            addPath(
                fill = SolidColor(Color.White),
                stroke = SolidColor(Color(0xFF1C399E)),
                strokeLineWidth = 0.402f,
                pathData = addPathNodes("m 339.4 205.15 c 0.0 1.1 -0.9 2.0 -2.0 2.0 c -1.1 0.0 -2.0 -0.9 -2.0 -2.0 c 0.0 -1.1 0.9 -2.0 2.0 -2.0 c 1.1 0.0 2.0 0.9 2.0 2.0 Z")
            )
            addPath(
                fill = SolidColor(Color.White),
                stroke = SolidColor(Color(0xFF1C399E)),
                strokeLineWidth = 0.324f,
                pathData = addPathNodes("m 332.13 202.88 c 0.0 0.6 -0.5 1.09 -1.11 1.09 c -0.61 0.0 -1.11 -0.49 -1.11 -1.09 c 0.0 -0.6 0.5 -1.09 1.11 -1.09 c 0.61 0.0 1.11 0.49 1.11 1.09 Z")
            )
            addPath(
                fill = SolidColor(Color.White),
                stroke = SolidColor(Color(0xFF1C399E)),
                strokeLineWidth = 0.366f,
                pathData = addPathNodes("m 333.39 199.21 c 0.0 0.58 -0.47 1.05 -1.05 1.05 c -0.58 0.0 -1.05 -0.47 -1.05 -1.05 c 0.0 -0.58 0.47 -1.05 1.05 -1.05 c 0.58 0.0 1.05 0.47 1.05 1.05 Z")
            )
            addPath(
                fill = SolidColor(Color.White),
                stroke = SolidColor(Color(0xFF1C399E)),
                strokeLineWidth = 0.366f,
                pathData = addPathNodes("M 325.49 196.18 a 0.92 0.92 0.0 1 0 1.85 0.0 a 0.92 0.92 0.0 1 0 -1.85 0.0 Z")
            )
            addPath(
                fill = SolidColor(Color.Black),
                stroke = SolidColor(Color.Black),
                strokeLineWidth = 0.13160126f,
                pathData = addPathNodes("m 328.1 243.24 c 0.0 0.59 -0.94 1.18 -0.94 1.88 c 0.0 0.82 0.94 1.18 3.88 1.18 v 0.47 c -2.94 0.0 -4.12 -0.59 -4.12 -1.65 c 0.0 -0.82 0.94 -1.41 0.94 -1.88 c 0.0 -0.35 -0.35 -2.35 -3.88 -2.35 c 3.53 0.0 4.12 1.77 4.12 2.35 Z")
            )
            addPath(
                fill = SolidColor(Color.White),
                stroke = SolidColor(Color(0xFF1C399E)),
                strokeLineWidth = 0.288f,
                pathData = addPathNodes("m 332.29 246.54 c 0.0 0.69 -0.56 1.26 -1.26 1.26 c -0.69 0.0 -1.26 -0.56 -1.26 -1.26 c 0.0 -0.69 0.56 -1.26 1.26 -1.26 c 0.69 0.0 1.26 0.56 1.26 1.26 Z")
            )
            addPath(
                fill = SolidColor(Color.White),
                stroke = SolidColor(Color(0xFF1C399E)),
                strokeLineWidth = 0.239f,
                pathData = addPathNodes("m 327.73 245.11 c 0.0 0.38 -0.31 0.68 -0.7 0.68 c -0.39 0.0 -0.7 -0.31 -0.7 -0.68 c 0.0 -0.38 0.31 -0.68 0.7 -0.68 c 0.39 0.0 0.7 0.31 0.7 0.68 Z")
            )
            addPath(
                fill = SolidColor(Color.White),
                stroke = SolidColor(Color(0xFF1C399E)),
                strokeLineWidth = 0.265f,
                pathData = addPathNodes("m 328.52 242.81 c 0.0 0.37 -0.3 0.66 -0.66 0.66 c -0.37 0.0 -0.66 -0.3 -0.66 -0.66 c 0.0 -0.37 0.3 -0.66 0.66 -0.66 c 0.37 0.0 0.66 0.3 0.66 0.66 Z")
            )
            addPath(
                fill = SolidColor(Color.White),
                stroke = SolidColor(Color(0xFF1C399E)),
                strokeLineWidth = 0.265f,
                pathData = addPathNodes("M 323.56 240.91 a 0.58 0.58 0.0 1 0 1.16 0.0 a 0.58 0.58 0.0 1 0 -1.16 0.0 Z")
            )
            addPath(
                fill = SolidColor(Color.White),
                fillAlpha = 0.1f,
...
private var _ApplicationXKarbon: ImageVector? = null
