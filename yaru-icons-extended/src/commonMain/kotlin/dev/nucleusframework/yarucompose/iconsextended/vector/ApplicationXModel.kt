...
val ApplicationXModel: ImageVector
    get() {
        if (_ApplicationXModel != null) {
            return _ApplicationXModel!!
        }
        _ApplicationXModel = ImageVector.Builder(
            name = "ApplicationXModel",
            defaultWidth = 400.dp,
            ...
            addPath(
                fill = Brush.linearGradient(
                    ...
                    start = Offset(-240f, 31f),
                    end = Offset(-112f, 287f)
                ),
                strokeLineWidth = 1f,
                pathData = addPathNodes("m -134.92 47.0 c 35.3 0.0 39.09 3.63 38.92 38.99 V 159.0 V 232.01 C -95.83 267.37 -99.63 271.0 -134.92 271.0 h -98.16 c -35.3 0.0 -38.92 -3.63 -38.92 -38.99 V 159.0 V 85.99 C -272.0 50.62 -268.38 47.0 -233.08 47.0 Z")
            )
            addPath(
                stroke = SolidColor(Color.White),
                strokeLineWidth = 8f,
                pathFillType = PathFillType.EvenOdd,
                pathData = addPathNodes("m 100.0 136.0 l 52.0 -28.0 l 52.0 28.0 v 60.0 l -52.0 28.0 l -52.0 -28.0 Z")
            )
            addPath(
                stroke = SolidColor(Color.White),
                strokeLineWidth = 8f,
                pathFillType = PathFillType.EvenOdd,
                pathData = addPathNodes("m 204.0 136.0 l -52.0 28.0 l -52.0 -28.0")
            )
            addPath(
                stroke = SolidColor(Color.White),
                strokeLineWidth = 8f,
                pathFillType = PathFillType.EvenOdd,
                pathData = addPathNodes("m 152.0 160.0 v 64.0")
            )
            addPath(
                stroke = SolidColor(Color.White),
                strokeLineWidth = 2f,
                pathFillType = PathFillType.EvenOdd,
                pathData = addPathNodes("m 333.0 78.66 l 11.0 -5.92 l 11.0 5.92 l 0.0 12.68 l -11.0 5.92 l -11.0 -5.92 Z")
            )
            addPath(
                stroke = SolidColor(Color.White),
                strokeLineWidth = 2f,
                pathFillType = PathFillType.EvenOdd,
                pathData = addPathNodes("m 355.0 78.66 l -11.0 5.92 l -11.0 -5.92")
            )
            addPath(
                stroke = SolidColor(Color.White),
                strokeLineWidth = 2f,
                pathFillType = PathFillType.EvenOdd,
                pathData = addPathNodes("m 344.0 83.73 l 0.0 13.52")
            )
            addPath(
                stroke = SolidColor(Color.White),
                strokeLineWidth = 1f,
                pathFillType = PathFillType.EvenOdd,
                pathData = addPathNodes("m 328.5 144.59 l 7.5 -4.03 l 7.5 4.03 l 0.0 8.64 l -7.5 4.03 l -7.5 -4.03 Z")
            )
            addPath(
                stroke = SolidColor(Color.White),
                strokeLineWidth = 1f,
                pathFillType = PathFillType.EvenOdd,
                pathData = addPathNodes("m 343.5 144.59 l -7.5 4.03 l -7.5 -4.03")
            )
            addPath(
                stroke = SolidColor(Color.White),
                strokeLineWidth = 1f,
                pathFillType = PathFillType.EvenOdd,
                pathData = addPathNodes("m 336.0 148.04 l 0.0 9.21")
            )
            addPath(
                stroke = SolidColor(Color.White),
                strokeLineWidth = 1f,
                pathFillType = PathFillType.EvenOdd,
                pathData = addPathNodes("m 326.5 197.97 l 5.5 -2.95 l 5.5 2.95 l 0.0 6.33 l -5.5 2.95 l -5.5 -2.95 Z")
            )
            addPath(
                stroke = SolidColor(Color.White),
                strokeLineWidth = 1f,
                pathFillType = PathFillType.EvenOdd,
                pathData = addPathNodes("m 337.5 197.97 l -5.5 2.95 l -5.5 -2.95")
            )
            addPath(
                stroke = SolidColor(Color.White),
                strokeLineWidth = 1f,
                pathFillType = PathFillType.EvenOdd,
                pathData = addPathNodes("m 332.0 200.5 l 0.0 6.75")
            )
            addPath(
                stroke = SolidColor(Color.White),
                strokeLineWidth = 1f,
                pathFillType = PathFillType.EvenOdd,
                pathData = addPathNodes("m 324.5 242.35 l 3.5 -1.88 l 3.5 1.88 l 0.0 4.02 l -3.5 1.88 l -3.5 -1.88 Z")
            )
            addPath(
                stroke = SolidColor(Color.White),
                strokeLineWidth = 1f,
                pathFillType = PathFillType.EvenOdd,
                pathData = addPathNodes("m 331.5 242.35 l -3.5 1.88 l -3.5 -1.88")
            )
            addPath(
                stroke = SolidColor(Color.White),
                strokeLineWidth = 1f,
                pathFillType = PathFillType.EvenOdd,
                pathData = addPathNodes("m 328.0 243.96 l 0.0 4.29")
            )
            addPath(
                fill = SolidColor(Color.White),
                fillAlpha = 0.1f,
...
private var _ApplicationXModel: ImageVector? = null
