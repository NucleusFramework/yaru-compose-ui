...
val ApplicationXTheme: ImageVector
    get() {
        if (_ApplicationXTheme != null) {
            return _ApplicationXTheme!!
        }
        _ApplicationXTheme = ImageVector.Builder(
            name = "ApplicationXTheme",
            defaultWidth = 400.dp,
            ...
            addPath(
                ...
                strokeLineWidth = 0.38f,
                pathData = addPathNodes("m 332.15 240.34 l -0.52 0.0 l 0.0 0.49 L 332.15 240.83 c 0.03 0.0 0.05 0.0 0.06 0.0 c 0.0 0.01 0.0 0.02 0.0 0.03 l 0.0 2.04 c 0.0 0.09 -0.04 0.17 -0.06 0.17 l -3.81 0.0 c -0.38 0.0 -0.67 0.24 -0.67 0.55 l 0.0 0.31 l 0.49 0.0 l -0.0 -0.31 c 0.01 -0.02 0.08 -0.06 0.18 -0.06 l 3.81 0.0 c 0.32 0.0 0.55 -0.28 0.55 -0.66 l 0.0 -2.04 c 0.0 -0.33 -0.21 -0.53 -0.55 -0.53 Z")
            )
            addPath(
                fill = SolidColor(Color.LightGray),
                strokeLineWidth = 0.04f,
                pathData = addPathNodes("m 324.7 239.0 c -0.31 0.0 -0.56 0.25 -0.56 0.56 l 0.0 1.91 c 0.0 0.31 0.25 0.56 0.56 0.56 l 2.24 0.0 l 0.4 0.0 l 1.47 0.0 l 2.27 0.0 c 0.31 0.0 0.56 -0.25 0.56 -0.56 L 331.63 239.56 c 0.0 -0.31 -0.25 -0.56 -0.56 -0.56 l -2.27 0.0 l -1.47 0.0 l -0.4 0.0 Z")
            )
            addPath(
                fill = SolidColor(Color.LightGray),
                strokeLineWidth = 0.04f,
                pathData = addPathNodes("m 327.42 243.92 a 0.21 0.21 135.0 0 0 -0.2 0.14 l -0.41 1.25 A 0.71 0.71 135.0 0 0 326.78 245.54 l 0.0 3.28 a 0.18 0.18 0.0 0 0 0.18 0.18 l 0.78 0.0 l 0.16 0.0 l 0.0 0.0 l 0.21 0.0 l 0.74 0.0 a 0.18 0.18 45.0 0 0 0.18 -0.18 l 0.0 -3.27 a 0.77 0.77 135.0 0 0 -0.04 -0.24 l -0.4 -1.23 a 0.22 0.22 135.0 0 0 -0.21 -0.15 l -0.27 0.0 l -0.21 0.0 l -0.0 0.0 l -0.16 0.0 Z")
            )
            addPath(
                fill = SolidColor(Color.LightGray),
                strokeLineWidth = 0.53f,
                pathData = addPathNodes("m 337.91 194.87 l -0.73 0.0 l 0.0 0.69 L 337.91 195.56 c 0.04 0.0 0.07 0.0 0.08 0.01 c 0.0 0.01 0.0 0.02 0.0 0.04 l 0.0 2.86 c 0.0 0.13 -0.05 0.23 -0.08 0.23 l -5.34 0.0 c -0.54 0.0 -0.94 0.33 -0.94 0.77 l 0.0 0.43 l 0.69 0.0 l -0.0 -0.43 c 0.01 -0.02 0.11 -0.08 0.26 -0.08 l 5.34 0.0 c 0.45 0.0 0.77 -0.39 0.77 -0.92 l 0.0 -2.86 c 0.0 -0.46 -0.29 -0.74 -0.77 -0.74 Z")
            )
            addPath(
                fill = SolidColor(Color.LightGray),
                strokeLineWidth = 0.05f,
                pathData = addPathNodes("m 327.48 193.0 c -0.43 0.0 -0.78 0.35 -0.78 0.78 l 0.0 2.68 c 0.0 0.43 0.35 0.78 0.78 0.78 l 3.13 0.0 l 0.56 0.0 l 2.06 0.0 l 3.18 0.0 c 0.43 0.0 0.78 -0.35 0.78 -0.78 L 337.18 193.78 c 0.0 -0.43 -0.35 -0.78 -0.78 -0.78 l -3.18 0.0 l -2.06 0.0 l -0.56 0.0 Z")
            )
            addPath(
                fill = SolidColor(Color.LightGray),
                strokeLineWidth = 0.05f,
                pathData = addPathNodes("m 331.29 199.89 a 0.29 0.29 45.0 0 0 -0.28 0.2 l -0.57 1.75 A 0.99 0.99 0.0 0 0 330.39 202.16 l 0.0 4.59 a 0.26 0.26 135.0 0 0 0.26 0.26 l 1.09 0.0 l 0.22 0.0 l 0.0 0.0 l 0.29 0.0 l 1.03 0.0 a 0.25 0.25 135.0 0 0 0.25 -0.25 l 0.0 -4.58 a 1.08 1.08 45.0 0 0 -0.05 -0.33 l -0.56 -1.73 a 0.31 0.31 0.0 0 0 -0.29 -0.21 l -0.37 0.0 l -0.29 0.0 l -0.0 0.0 l -0.22 0.0 Z")
            )
            addPath(
                fill = SolidColor(Color.LightGray),
                strokeLineWidth = 0.65f,
                pathData = addPathNodes("m 343.25 141.66 l -0.91 0.0 l 0.0 0.85 L 343.25 142.51 c 0.05 0.0 0.08 0.0 0.1 0.01 c 0.0 0.01 0.0 0.03 0.0 0.06 l 0.0 3.53 c 0.0 0.16 -0.06 0.29 -0.1 0.29 l -6.59 0.0 c -0.66 0.0 -1.17 0.41 -1.17 0.95 l 0.0 0.54 l 0.85 0.0 l -0.0 -0.53 c 0.01 -0.03 0.14 -0.1 0.32 -0.1 l 6.59 0.0 c 0.55 0.0 0.95 -0.48 0.95 -1.14 l 0.0 -3.53 c 0.0 -0.57 -0.36 -0.91 -0.95 -0.91 Z")
            )
            addPath(
                fill = SolidColor(Color.LightGray),
                strokeLineWidth = 0.07f,
                pathData = addPathNodes("m 330.37 139.35 c -0.53 0.0 -0.97 0.43 -0.97 0.97 l 0.0 3.3 c 0.0 0.53 0.43 0.97 0.97 0.97 l 3.87 0.0 l 0.69 0.0 l 2.54 0.0 l 3.92 0.0 c 0.53 0.0 0.96 -0.43 0.96 -0.97 L 342.35 140.32 c 0.0 -0.53 -0.43 -0.97 -0.96 -0.97 l -3.92 0.0 l -2.54 0.0 l -0.69 0.0 Z")
            )
            addPath(
                fill = SolidColor(Color.LightGray),
                strokeLineWidth = 0.07f,
                pathData = addPathNodes("m 335.07 147.87 a 0.36 0.36 135.0 0 0 -0.34 0.25 l -0.71 2.16 A 1.23 1.23 45.0 0 0 333.96 150.66 l 0.0 5.66 a 0.32 0.32 0.0 0 0 0.32 0.32 l 1.35 0.0 l 0.28 0.0 l 0.0 0.0 l 0.36 0.0 l 1.28 0.0 a 0.31 0.31 45.0 0 0 0.31 -0.31 l 0.0 -5.66 a 1.33 1.33 0.0 0 0 -0.07 -0.41 l -0.7 -2.13 a 0.38 0.38 45.0 0 0 -0.36 -0.26 l -0.46 0.0 l -0.36 0.0 l -0.0 0.0 l -0.28 0.0 Z")
            )
            addPath(
                fill = SolidColor(Color.LightGray),
                strokeLineWidth = 0.98f,
                pathData = addPathNodes("m 354.73 74.47 l -1.36 0.0 l 0.0 1.28 L 354.73 75.75 c 0.07 0.0 0.12 0.01 0.15 0.01 c 0.0 0.02 0.01 0.05 0.01 0.08 l 0.0 5.3 c 0.0 0.24 -0.09 0.43 -0.16 0.43 l -9.91 0.0 c -1.0 0.0 -1.75 0.61 -1.75 1.43 l 0.0 0.81 l 1.28 0.0 l -0.0 -0.8 c 0.02 -0.04 0.2 -0.16 0.48 -0.16 l 9.91 0.0 c 0.83 0.0 1.43 -0.72 1.43 -1.71 l 0.0 -5.3 c 0.0 -0.86 -0.54 -1.37 -1.43 -1.37 Z")
            )
            addPath(
                fill = SolidColor(Color.LightGray),
                strokeLineWidth = 0.1f,
                pathData = addPathNodes("m 335.36 71.0 c -0.8 0.0 -1.45 0.65 -1.45 1.45 l 0.0 4.97 c 0.0 0.8 0.65 1.45 1.45 1.45 l 5.82 0.0 l 1.04 0.0 l 3.82 0.0 l 5.9 0.0 c 0.8 0.0 1.45 -0.65 1.45 -1.45 L 353.38 72.45 c 0.0 -0.8 -0.65 -1.45 -1.45 -1.45 l -5.9 0.0 l -3.82 0.0 l -1.04 0.0 Z")
            )
            addPath(
                fill = SolidColor(Color.LightGray),
                strokeLineWidth = 0.1f,
                pathData = addPathNodes("m 342.43 83.8 a 0.54 0.54 45.0 0 0 -0.52 0.37 l -1.06 3.25 A 1.84 1.84 45.0 0 0 340.76 88.01 l 0.0 8.52 a 0.48 0.48 135.0 0 0 0.48 0.48 l 2.02 0.0 l 0.41 0.0 l 0.0 0.0 l 0.54 0.0 l 1.92 0.0 a 0.46 0.46 0.0 0 0 0.46 -0.46 l 0.0 -8.51 a 2.0 2.0 0.0 0 0 -0.1 -0.62 l -1.05 -3.21 a 0.57 0.57 45.0 0 0 -0.54 -0.39 l -0.69 0.0 l -0.54 0.0 l -0.0 0.0 l -0.41 0.0 Z")
            )
            addPath(
                fill = SolidColor(Color.LightGray),
                strokeLineWidth = 4.91746f,
                pathData = addPathNodes("m 207.27 108.16 h -6.82 v 6.41 L 207.27 114.57 c 0.37 0.0 0.61 0.03 0.76 0.06 c 0.01 0.1 0.03 0.23 0.03 0.42 v 26.58 c 0.0 1.2 -0.48 2.17 -0.79 2.17 h -49.69 c -5.01 0.0 -8.78 3.08 -8.78 7.17 v 4.04 h 6.4 l -0.0 -4.03 c 0.11 -0.21 1.02 -0.78 2.38 -0.78 h 49.69 c 4.17 0.0 7.19 -3.61 7.19 -8.57 v -26.58 c 0.0 -4.31 -2.69 -6.88 -7.19 -6.88 Z")
            )
            addPath(
                fill = SolidColor(Color.LightGray),
                strokeLineWidth = 0.497797f,
                pathData = addPathNodes("m 110.22 90.75 c -4.03 0.0 -7.28 3.24 -7.28 7.28 v 24.9 c 0.0 4.03 3.24 7.28 7.28 7.28 h 29.15 h 5.2 h 19.15 h 29.55 c 4.02 0.0 7.26 -3.24 7.26 -7.28 L 200.52 98.02 c 0.0 -4.03 -3.24 -7.28 -7.26 -7.28 h -29.55 h -19.15 h -5.2 Z")
            )
            addPath(
                fill = SolidColor(Color.LightGray),
                strokeLineWidth = 0.500177f,
                pathData = addPathNodes("m 145.67 154.92 a 2.72 2.72 0.0 0 0 -2.59 1.88 l -5.33 16.3 A 9.25 9.25 0.0 0 0 137.3 175.97 v 42.68 a 2.4 2.4 0.0 0 0 2.4 2.4 h 10.15 h 2.08 h 0.02 h 2.69 h 9.61 a 2.33 2.33 0.0 0 0 2.32 -2.32 v -42.63 a 10.02 10.02 0.0 0 0 -0.5 -3.11 l -5.25 -16.08 a 2.87 2.87 0.0 0 0 -2.73 -1.98 h -3.46 h -2.69 h -0.02 h -2.08 Z")
            )
            group(
            ...
            group(
                clipPathData = addPathNodes("m 327.86 189.0 c -4.41 0.0 -4.89 0.45 -4.87 4.87 L 323.0 200.0 L 323.0 206.13 C 322.98 210.55 323.45 211.0 327.86 211.0 h 8.27 C 340.55 211.0 341.0 210.55 341.0 206.13 L 341.0 200.0 L 341.0 193.87 C 341.0 189.45 340.55 189.0 336.13 189.0 Z")
            ) {
                addPath(
                    fill = Brush.linearGradient(
                        colorStops = arrayOf(
                    ...
                    strokeAlpha = 0.4f,
                    strokeLineWidth = 2f,
                    pathData = addPathNodes("m 327.86 189.0 c -4.41 0.0 -4.89 0.45 -4.87 4.87 L 323.0 200.0 L 323.0 206.13 C 322.98 210.55 323.45 211.0 327.86 211.0 h 8.27 C 340.55 211.0 341.0 210.55 341.0 206.13 L 341.0 200.0 L 341.0 193.87 C 341.0 189.45 340.55 189.0 336.13 189.0 Z")
                )
            }
            group(
...
private var _ApplicationXTheme: ImageVector? = null
