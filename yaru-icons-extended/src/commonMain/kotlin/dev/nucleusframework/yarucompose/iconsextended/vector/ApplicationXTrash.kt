...
val ApplicationXTrash: ImageVector
    get() {
        if (_ApplicationXTrash != null) {
            return _ApplicationXTrash!!
        }
        _ApplicationXTrash = ImageVector.Builder(
            name = "ApplicationXTrash",
            defaultWidth = 400.dp,
            ...
            addPath(
                ...
                strokeAlpha = 0.5f,
                strokeLineWidth = 5.999977f,
                pathFillType = PathFillType.EvenOdd,
                pathData = addPathNodes("m 152.0 127.0 v 30.0 l 18.0 18.0")
            )
            addPath(
                fillAlpha = 0.75f,
                stroke = SolidColor(Color(0xFF808080)),
                strokeAlpha = 0.75f,
                strokeLineWidth = 0.87499666f,
                pathFillType = PathFillType.EvenOdd,
                pathData = addPathNodes("M 336.0 143.63 V 148.0 l 2.62 2.62")
            )
            addPath(
                fill = SolidColor(Color(0xFF808080)),
                fillAlpha = 0.75f,
                strokeAlpha = 0.75f,
                strokeLineWidth = 3.4999866f,
                strokeLineCap = StrokeCap.Round,
                strokeLineJoin = StrokeJoin.Round,
                pathData = addPathNodes("m 329.0 141.0 l -1.0 6.0 l 6.0 -1.0 l -2.32 -2.32 A 6.12 6.12 0.0 0 1 336.0 141.88 A 6.12 6.12 0.0 0 1 342.13 148.0 A 6.12 6.12 0.0 0 1 336.0 154.13 A 6.12 6.12 0.0 0 1 330.22 150.0 h -0.91 a 7.0 7.0 0.0 0 0 6.69 5.0 a 7.0 7.0 0.0 0 0 7.0 -7.0 a 7.0 7.0 0.0 0 0 -7.0 -7.0 a 7.0 7.0 0.0 0 0 -4.94 2.06 Z")
            )
            addPath(
                fillAlpha = 0.5f,
                stroke = SolidColor(Color(0xFF808080)),
                ...
                pathFillType = PathFillType.EvenOdd,
                pathData = addPathNodes("m 344.0 77.13 v 6.87 l 4.12 4.12")
            )
            addPath(
                fillAlpha = 0.75f,
                stroke = SolidColor(Color(0xFF808080)),
                strokeAlpha = 0.75f,
                strokeLineWidth = 0.74999845f,
                pathFillType = PathFillType.EvenOdd,
                pathData = addPathNodes("M 332.0 196.25 V 200.0 l 2.25 2.25")
            )
            addPath(
                fillAlpha = 0.75f,
                stroke = SolidColor(Color(0xFF808080)),
                ...
                strokeLineWidth = 1f,
                pathFillType = PathFillType.EvenOdd,
                pathData = addPathNodes("M 328.0 241.0 L 328.0 244.0 l 2.0 2.0")
            )
            addPath(
                fill = SolidColor(Color(0xFF808080)),
                fillAlpha = 0.5f,
                strokeAlpha = 0.5f,
                strokeLineWidth = 3.8999999f,
                pathData = addPathNodes("m 344.0 73.0 c -3.45 0.0 -6.65 1.62 -8.71 4.29 L 333.0 75.0 l -2.0 8.0 l 8.0 -2.0 l -2.72 -2.72 C 338.08 75.86 340.93 74.38 344.0 74.38 c 5.32 0.0 9.63 4.31 9.63 9.63 c 0.0 5.32 -4.31 9.62 -9.63 9.63 c -4.97 -0.0 -9.06 -3.77 -9.56 -8.63 h -1.37 c 0.51 5.62 5.22 9.99 10.93 10.0 c 6.08 -0.0 11.0 -4.92 11.0 -11.0 c 0.0 -6.08 -4.92 -11.0 -11.0 -11.0 Z")
            )
            addPath(
                fill = SolidColor(Color(0xFF999999)),
                strokeLineWidth = 0.01860573f,
                pathData = addPathNodes("m 328.22 239.94 c -0.5 0.0 -0.98 0.09 -1.44 0.28 c -0.37 0.14 -0.7 0.34 -1.0 0.59 l -0.87 -0.82 l -0.31 2.64 l 2.5 -0.6 l -0.87 -0.73 c 0.21 -0.18 0.45 -0.33 0.72 -0.45 c 0.39 -0.16 0.81 -0.25 1.26 -0.25 c 0.45 0.0 0.87 0.08 1.25 0.25 c 0.39 0.16 0.72 0.4 0.99 0.7 c 0.27 0.3 0.49 0.66 0.65 1.08 c 0.16 0.42 0.23 0.81 0.23 1.32 c 0.0 0.51 -0.08 0.9 -0.23 1.32 c -0.16 0.42 -0.37 0.79 -0.65 1.09 c -0.27 0.3 -0.61 0.53 -0.99 0.7 c -0.38 0.16 -0.8 0.24 -1.25 0.24 c -0.45 0.0 -0.87 -0.08 -1.26 -0.24 c -0.38 -0.17 -0.7 -0.4 -0.98 -0.7 c -0.27 -0.3 -0.49 -0.67 -0.65 -1.09 c -0.16 -0.42 -0.23 -0.89 -0.23 -1.4 c 0.0 -0.15 0.01 -0.29 0.02 -0.42 h -0.65 c -0.02 0.16 -0.03 0.33 -0.03 0.5 c 0.0 0.64 0.1 1.21 0.31 1.71 c 0.21 0.5 0.48 0.92 0.83 1.27 c 0.35 0.34 0.75 0.61 1.2 0.79 c 0.46 0.18 0.94 0.27 1.44 0.27 c 0.5 0.0 0.97 -0.09 1.43 -0.27 c 0.46 -0.19 0.86 -0.45 1.2 -0.79 c 0.35 -0.35 0.63 -0.77 0.84 -1.27 c 0.21 -0.5 0.31 -1.07 0.31 -1.71 c 0.0 -0.63 -0.1 -1.2 -0.31 -1.7 c -0.21 -0.51 -0.49 -0.93 -0.84 -1.27 c -0.34 -0.34 -0.74 -0.6 -1.2 -0.78 c -0.45 -0.19 -0.93 -0.28 -1.43 -0.28 Z")
            )
            addPath(
                fill = SolidColor(Color(0xFF808080)),
                fillAlpha = 0.5f,
                ...
                pathData = addPathNodes("M 152.0 109.0 A 48.0 48.0 0.0 0 0 109.5 134.75 L 104.0 132.0 v 20.0 l 16.0 -12.0 l -5.1 -2.55 A 42.0 42.0 0.0 0 1 152.0 115.0 a 42.0 42.0 0.0 0 1 42.0 42.0 a 42.0 42.0 0.0 0 1 -42.0 42.0 a 42.0 42.0 0.0 0 1 -41.97 -41.2 l -5.96 0.6 A 48.0 48.0 0.0 0 0 152.0 205.0 A 48.0 48.0 0.0 0 0 200.0 157.0 A 48.0 48.0 0.0 0 0 152.0 109.0 Z")
            )
            addPath(
                fill = SolidColor(Color(0xFF808080)),
                fillAlpha = 0.75f,
                strokeAlpha = 0.75f,
                strokeLineWidth = 1.375f,
                pathData = addPathNodes("m 326.0 194.0 l -1.0 5.0 l 5.0 -1.0 l -1.71 -1.71 A 5.25 5.25 0.0 0 1 332.0 194.75 A 5.25 5.25 0.0 0 1 337.25 200.0 A 5.25 5.25 0.0 0 1 332.0 205.25 A 5.25 5.25 0.0 0 1 327.7 203.0 h -0.89 a 6.0 6.0 0.0 0 0 5.19 3.0 a 6.0 6.0 0.0 0 0 6.0 -6.0 a 6.0 6.0 0.0 0 0 -6.0 -6.0 a 6.0 6.0 0.0 0 0 -4.23 1.77 Z")
            )
            addPath(
                fill = SolidColor(Color.White),
                fillAlpha = 0.1f,
...
private var _ApplicationXTrash: ImageVector? = null
