...
val ApplicationXVirtualboxHdd: ImageVector
    get() {
        if (_ApplicationXVirtualboxHdd != null) {
            return _ApplicationXVirtualboxHdd!!
        }
        _ApplicationXVirtualboxHdd = ImageVector.Builder(
            name = "ApplicationXVirtualboxHdd",
            defaultWidth = 400.dp,
            ...
            addPath(
                fill = Brush.linearGradient(
                    colorStops = arrayOf(
                        0f to Color(0xFF4600D9),
                        1f to Color(0xFF7431FE)
                    ),
...
private var _ApplicationXVirtualboxHdd: ImageVector? = null
