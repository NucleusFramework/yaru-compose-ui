...
val ApplicationXVirtualboxOva: ImageVector
    get() {
        if (_ApplicationXVirtualboxOva != null) {
            return _ApplicationXVirtualboxOva!!
        }
        _ApplicationXVirtualboxOva = ImageVector.Builder(
            name = "ApplicationXVirtualboxOva",
            defaultWidth = 400.dp,
            ...
            addPath(
                fill = Brush.linearGradient(
                    colorStops = arrayOf(
                        0f to Color(0xFFD36400),
                        1f to Color(0xFFFF902D)
                    ),
...
private var _ApplicationXVirtualboxOva: ImageVector? = null
