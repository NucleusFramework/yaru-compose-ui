...
val ApplicationXVirtualboxOvf: ImageVector
    get() {
        if (_ApplicationXVirtualboxOvf != null) {
            return _ApplicationXVirtualboxOvf!!
        }
        _ApplicationXVirtualboxOvf = ImageVector.Builder(
            name = "ApplicationXVirtualboxOvf",
            defaultWidth = 400.dp,
            ...
            addPath(
                fill = Brush.linearGradient(
                    colorStops = arrayOf(
                        0f to Color(0xFFD37E00),
                        1f to Color(0xFFFFAA2D)
                    ),
...
private var _ApplicationXVirtualboxOvf: ImageVector? = null
