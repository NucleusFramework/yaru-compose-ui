...
val ApplicationXVirtualboxVbox: ImageVector
    get() {
        if (_ApplicationXVirtualboxVbox != null) {
            return _ApplicationXVirtualboxVbox!!
        }
        _ApplicationXVirtualboxVbox = ImageVector.Builder(
            name = "ApplicationXVirtualboxVbox",
            defaultWidth = 400.dp,
            ...
            addPath(
                fill = Brush.linearGradient(
                    colorStops = arrayOf(
                        0f to Color(0xFF007FD5),
                        1f to Color(0xFF2FABFF)
                    ),
...
private var _ApplicationXVirtualboxVbox: ImageVector? = null
