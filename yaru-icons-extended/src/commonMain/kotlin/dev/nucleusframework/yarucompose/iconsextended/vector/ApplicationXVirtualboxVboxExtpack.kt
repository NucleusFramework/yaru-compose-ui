...
val ApplicationXVirtualboxVboxExtpack: ImageVector
    get() {
        if (_ApplicationXVirtualboxVboxExtpack != null) {
            return _ApplicationXVirtualboxVboxExtpack!!
        }
        _ApplicationXVirtualboxVboxExtpack = ImageVector.Builder(
            name = "ApplicationXVirtualboxVboxExtpack",
            defaultWidth = 400.dp,
            ...
            addPath(
                fill = Brush.linearGradient(
                    colorStops = arrayOf(
                        0f to Color(0xFF497F00),
                        1f to Color(0xFF75CB00)
                    ),
            ...
            addPath(
                ...
                strokeLineWidth = 8f,
                pathData = addPathNodes("m 64.0 125.0 h 45.77 L 124.98 179.05 L 145.08 108.11 L 159.5 147.0 L 173.96 108.11 L 191.0 157.0 h 49.0")
            )
            addPath(
                stroke = SolidColor(Color.White),
                strokeLineWidth = 2f,
                pathData = addPathNodes("m 325.0 77.0 h 9.88 l 3.28 11.67 l 4.34 -15.32 l 3.11 8.4 l 3.12 -8.4 L 352.42 84.0 H 363.0")
            )
            addPath(
                stroke = SolidColor(Color.White),
                strokeLineWidth = 1f,
                pathData = addPathNodes("m 323.5 142.5 h 6.5 l 2.16 7.68 l 2.86 -10.08 l 2.05 5.52 l 2.05 -5.52 L 341.5 147.5 h 7.0")
            )
            addPath(
                stroke = SolidColor(Color.White),
                strokeLineWidth = 1f,
                pathData = addPathNodes("m 322.5 195.5 h 4.94 l 1.64 5.84 l 2.17 -7.66 l 1.56 4.2 l 1.56 -4.2 L 336.21 199.0 H 341.5")
            )
            addPath(
                stroke = SolidColor(Color.White),
                strokeLineWidth = 1f,
                pathData = addPathNodes("m 321.5 242.5 h 3.0 l 1.5 4.5 l 1.49 -5.75 l 1.07 2.87 l 1.07 -2.87 L 331.0 245.5 h 3.5")
            )
            addPath(
...
private var _ApplicationXVirtualboxVboxExtpack: ImageVector? = null
