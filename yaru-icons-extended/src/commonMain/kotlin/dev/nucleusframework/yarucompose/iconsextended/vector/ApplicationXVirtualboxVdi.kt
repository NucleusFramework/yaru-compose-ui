...
val ApplicationXVirtualboxVdi: ImageVector
    get() {
        if (_ApplicationXVirtualboxVdi != null) {
            return _ApplicationXVirtualboxVdi!!
        }
        _ApplicationXVirtualboxVdi = ImageVector.Builder(
            name = "ApplicationXVirtualboxVdi",
            defaultWidth = 400.dp,
            ...
            addPath(
                fill = Brush.linearGradient(
                    colorStops = arrayOf(
                        0f to Color(0xFFD33A00),
                        1f to Color(0xFFFF672D)
                    ),
...
private var _ApplicationXVirtualboxVdi: ImageVector? = null
