...
val AptdaemonDownload: ImageVector
    get() {
        if (_AptdaemonDownload != null) {
            return _AptdaemonDownload!!
        }
        _AptdaemonDownload = ImageVector.Builder(
            name = "AptdaemonDownload",
            defaultWidth = 400.dp,
            ...
            addPath(
                fill = SolidColor(Color.White),
                strokeLineWidth = 1.852435f,
                pathData = addPathNodes("m 144.0 100.0 h 16.0 v 28.0 h 12.0 c 0.0 0.0 -7.69 16.31 -20.0 36.0 c -12.31 -19.69 -20.0 -36.0 -20.0 -36.0 h 12.0 Z")
            )
            addPath(
                fill = SolidColor(Color.White),
                strokeLineWidth = 1.8524349f,
                pathData = addPathNodes("m 342.02 72.0 h 4.0 v 5.0 H 349.0 c 0.0 0.0 -2.0 4.0 -4.98 8.0 C 341.0 81.0 339.0 77.0 339.0 77.0 h 3.02 Z")
            )
            addPath(
                fill = SolidColor(Color.White),
                strokeLineWidth = 1.8524349f,
                pathData = addPathNodes("m 334.0 138.0 h 4.0 l 0.02 5.0 H 341.0 c 0.0 0.0 -2.02 4.0 -5.0 8.0 c -3.02 -4.0 -5.0 -8.0 -5.0 -8.0 h 3.02 Z")
            )
            addPath(
                fill = SolidColor(Color.White),
                strokeLineWidth = 1.8524349f,
                pathData = addPathNodes("m 331.0 194.0 h 2.0 v 3.0 h 2.0 c 0.0 0.0 -0.75 3.0 -2.99 6.0 C 329.75 200.0 329.0 197.0 329.0 197.0 h 2.0 Z")
            )
            addPath(
                fill = SolidColor(Color.White),
                strokeLineWidth = 1.8524348f,
                pathData = addPathNodes("m 327.0 240.0 h 1.0 v 2.0 h 1.33 c 0.0 0.0 -0.34 1.5 -1.83 3.5 c -1.51 -2.0 -1.83 -3.5 -1.83 -3.5 H 327.0 Z")
            )
            addPath(
                fill = SolidColor(Color.White),
                fillAlpha = 0.3f,
...
private var _AptdaemonDownload: ImageVector? = null
