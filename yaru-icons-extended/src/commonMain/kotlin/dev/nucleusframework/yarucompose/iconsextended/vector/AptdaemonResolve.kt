...
val AptdaemonResolve: ImageVector
    get() {
        if (_AptdaemonResolve != null) {
            return _AptdaemonResolve!!
        }
        _AptdaemonResolve = ImageVector.Builder(
            name = "AptdaemonResolve",
            defaultWidth = 400.dp,
            ...
            addPath(
                ...
                pathData = addPathNodes("m 146.0 96.0 c -16.57 0.0 -30.0 13.43 -30.0 30.0 c 0.0 16.57 13.43 30.0 30.0 30.0 c 6.57 -0.01 12.95 -2.18 18.17 -6.18 l 11.0 11.0 c 3.77 3.93 9.58 -1.89 5.66 -5.66 L 169.84 144.18 C 173.83 138.96 175.99 132.57 176.0 126.0 C 176.0 109.43 162.57 96.0 146.0 96.0 Z M 146.0 104.0 c 12.15 0.0 22.0 9.85 22.0 22.0 c 0.0 12.15 -9.85 22.0 -22.0 22.0 c -12.15 0.0 -22.0 -9.85 -22.0 -22.0 c 0.0 -12.15 9.85 -22.0 22.0 -22.0 Z")
            )
            addPath(
                fill = SolidColor(Color(0xFFE6E6E6)),
                strokeLineWidth = 8f,
                strokeLineCap = StrokeCap.Round,
                strokeLineJoin = StrokeJoin.Round,
                pathData = addPathNodes("M 342.5 70.0 A 6.5 6.5 0.0 0 0 336.0 76.5 A 6.5 6.5 0.0 0 0 342.5 83.0 A 6.5 6.5 0.0 0 0 346.33 81.74 L 349.29 84.71 A 1.0 1.0 0.0 1 0 350.71 83.29 L 347.74 80.33 A 6.5 6.5 0.0 0 0 349.0 76.5 A 6.5 6.5 0.0 0 0 342.5 70.0 Z M 342.5 72.0 A 4.5 4.5 0.0 0 1 347.0 76.5 A 4.5 4.5 0.0 0 1 342.5 81.0 A 4.5 4.5 0.0 0 1 338.0 76.5 A 4.5 4.5 0.0 0 1 342.5 72.0 Z")
            )
            addPath(
                fill = SolidColor(Color(0xFFE6E6E6)),
                ...
                strokeLineCap = StrokeCap.Round,
                strokeLineJoin = StrokeJoin.Round,
                pathData = addPathNodes("m 334.5 138.0 c -2.49 0.0 -4.5 2.01 -4.5 4.5 c 0.0 2.49 2.01 4.5 4.5 4.5 c 1.02 -0.0 2.01 -0.35 2.8 -0.99 l 2.34 2.34 c 0.47 0.49 1.2 -0.24 0.71 -0.71 l -2.34 -2.34 c 0.64 -0.8 0.98 -1.79 0.98 -2.81 c 0.0 -2.49 -2.01 -4.5 -4.5 -4.5 Z M 334.5 139.0 c 1.93 0.0 3.5 1.57 3.5 3.5 c 0.0 1.93 -1.57 3.5 -3.5 3.5 c -1.93 0.0 -3.5 -1.57 -3.5 -3.5 c 0.0 -1.93 1.57 -3.5 3.5 -3.5 Z")
            )
            addPath(
                fill = SolidColor(Color(0xFFE6E6E6)),
                strokeLineWidth = 2f,
                strokeLineCap = StrokeCap.Round,
                strokeLineJoin = StrokeJoin.Round,
                pathData = addPathNodes("M 331.0 193.0 A 4.0 4.0 0.0 0 0 327.0 197.0 A 4.0 4.0 0.0 0 0 331.0 201.0 A 4.0 4.0 0.0 0 0 333.45 200.16 L 335.65 202.35 A 0.5 0.5 0.0 1 0 336.35 201.65 L 334.16 199.45 A 4.0 4.0 0.0 0 0 335.0 197.0 A 4.0 4.0 0.0 0 0 331.0 193.0 Z M 331.0 194.0 A 3.0 3.0 0.0 0 1 334.0 197.0 A 3.0 3.0 0.0 0 1 331.0 200.0 A 3.0 3.0 0.0 0 1 328.0 197.0 A 3.0 3.0 0.0 0 1 331.0 194.0 Z")
            )
            addPath(
                fill = SolidColor(Color(0xFFE6E6E6)),
                strokeLineWidth = 2f,
                strokeLineCap = StrokeCap.Round,
                strokeLineJoin = StrokeJoin.Round,
                pathData = addPathNodes("M 326.5 239.0 A 2.5 2.5 0.0 0 0 324.0 241.5 A 2.5 2.5 0.0 0 0 326.5 244.0 A 2.5 2.5 0.0 0 0 327.88 243.58 L 329.65 245.35 A 0.5 0.5 0.0 1 0 330.35 244.65 L 328.58 242.88 A 2.5 2.5 0.0 0 0 329.0 241.5 A 2.5 2.5 0.0 0 0 326.5 239.0 Z M 326.5 240.0 A 1.5 1.5 0.0 0 1 328.0 241.5 A 1.5 1.5 0.0 0 1 326.5 243.0 A 1.5 1.5 0.0 0 1 325.0 241.5 A 1.5 1.5 0.0 0 1 326.5 240.0 Z")
            )
            addPath(
                fill = SolidColor(Color.White),
                fillAlpha = 0.3f,
...
private var _AptdaemonResolve: ImageVector? = null
