...
val DriveHarddiskSolidstate: ImageVector
    get() {
        if (_DriveHarddiskSolidstate != null) {
            return _DriveHarddiskSolidstate!!
        }
        _DriveHarddiskSolidstate = ImageVector.Builder(
            name = "DriveHarddiskSolidstate",
            defaultWidth = 400.dp,
            ...
            addPath(
                ...
                strokeLineWidth = 1.0015748f,
                pathData = addPathNodes("m 324.0 248.5 h 8.0")
            )
            addPath(
                fillAlpha = 0.2f,
                ...
                strokeAlpha = 0.2f,
                strokeLineWidth = 1.0015748f,
                pathData = addPathNodes("m 324.0 249.5 h 8.0")
            )
            addPath(
                fillAlpha = 0.4f,
...
private var _DriveHarddiskSolidstate: ImageVector? = null
