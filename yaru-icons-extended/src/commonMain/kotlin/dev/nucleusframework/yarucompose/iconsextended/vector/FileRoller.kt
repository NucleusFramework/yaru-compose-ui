...
val FileRoller: ImageVector
    get() {
        if (_FileRoller != null) {
            return _FileRoller!!
        }
        _FileRoller = ImageVector.Builder(
            name = "FileRoller",
            defaultWidth = 400.dp,
            ...
            addPath(
                ...
                strokeAlpha = 0.1f,
                strokeLineWidth = 2f,
                pathData = addPathNodes("m 344.0 61.5 v 45.0 h 8.77 c 8.23 0.0 9.73 -0.91 9.73 -9.75 V 84.0 V 71.25 C 362.5 62.41 361.0 61.5 352.77 61.5 Z")
            )
            addPath(
                fill = SolidColor(Color.White),
                fillAlpha = 0.1f,
            ...
            addPath(
                ...
                strokeAlpha = 0.1f,
                strokeLineWidth = 15f,
                pathData = addPathNodes("m 152.0 44.0 v 8.0 h 8.0 v -8.0 Z M 152.0 52.0 h -8.0 v 8.0 h 8.0 Z M 152.0 60.0 v 8.0 h 8.0 v -8.0 Z M 152.0 68.0 h -8.0 v 8.0 h 8.0 Z M 152.0 76.0 v 8.0 h 8.0 v -8.0 Z M 152.0 84.0 h -8.0 v 8.0 h 8.0 Z M 152.0 92.0 v 8.0 h 8.0 v -8.0 Z M 152.0 100.0 h -8.0 v 8.0 h 8.0 Z M 152.0 108.0 v 8.0 h 8.0 v -8.0 Z M 152.0 116.0 h -8.0 v 8.0 h 8.0 Z M 152.0 124.0 v 8.0 h 8.0 v -8.0 Z M 152.0 132.0 h -8.0 v 8.0 h 8.0 Z M 152.0 140.0 L 152.0 148.0 h 8.0 v -8.0 Z")
            )
            addPath(
                fill = SolidColor(Color.Black),
                fillAlpha = 0.2f,
                strokeAlpha = 0.2f,
                strokeLineWidth = 15f,
                pathData = addPathNodes("m 144.0 46.0 v 8.0 h 8.0 v -8.0 Z M 152.0 54.0 v 8.0 h 8.0 v -8.0 Z M 152.0 62.0 h -8.0 v 8.0 h 8.0 Z M 152.0 70.0 v 8.0 h 8.0 v -8.0 Z M 152.0 78.0 h -8.0 v 8.0 h 8.0 Z M 152.0 86.0 v 8.0 h 8.0 v -8.0 Z M 152.0 94.0 h -8.0 v 8.0 h 8.0 Z M 152.0 102.0 v 8.0 h 8.0 v -8.0 Z M 152.0 110.0 h -8.0 v 8.0 h 8.0 Z M 152.0 118.0 v 8.0 h 8.0 v -8.0 Z M 152.0 126.0 h -8.0 v 8.0 h 8.0 Z M 152.0 134.0 L 152.0 142.0 h 8.0 v -8.0 Z M 152.0 142.0 h -8.0 v 8.0 v 30.0 c 0.0 1.11 0.89 2.0 2.0 2.0 h 12.0 c 1.11 0.0 2.0 -0.89 2.0 -2.0 v -30.0 h -8.0 Z M 148.0 170.0 h 8.0 v 8.0 h -8.0 Z")
            )
            addPath(
                fill = SolidColor(Color(0xFFFAF8F6)),
                strokeLineWidth = 15f,
                pathData = addPathNodes("m 144.0 148.0 v 30.0 c 0.0 1.11 0.89 2.0 2.0 2.0 h 12.0 c 1.11 0.0 2.0 -0.89 2.0 -2.0 v -30.0 Z M 148.0 168.0 h 8.0 v 8.0 h -8.0 Z")
            )
            addPath(
                fill = SolidColor(Color.Black),
                fillAlpha = 0.2f,
                strokeAlpha = 0.2f,
                strokeLineWidth = 15f,
                pathData = addPathNodes("M 342.0 83.0 V 89.5 c 0.0 0.28 0.22 0.5 0.5 0.5 h 3.0 c 0.28 0.0 0.5 -0.22 0.5 -0.5 V 83.0 Z M 343.0 87.0 h 2.0 v 2.0 h -2.0 Z")
            )
            addPath(
                fill = SolidColor(Color(0xFFFAF8F6)),
                strokeLineWidth = 15f,
                pathData = addPathNodes("M 342.0 82.0 V 88.5 c 0.0 0.28 0.22 0.5 0.5 0.5 h 3.0 c 0.28 0.0 0.5 -0.22 0.5 -0.5 V 82.0 Z M 343.0 86.0 h 2.0 v 2.0 h -2.0 Z")
            )
            addPath(
                fill = SolidColor(Color(0xFFF1F0E9)),
                strokeLineWidth = 15f,
                pathData = addPathNodes("m 344.0 62.0 h 2.0 v 2.0 h -2.0 Z M 344.0 64.0 v 2.0 h -2.0 v -2.0 Z M 344.0 66.0 h 2.0 v 2.0 h -2.0 Z M 344.0 68.0 v 2.0 h -2.0 v -2.0 Z M 344.0 70.0 h 2.0 v 2.0 h -2.0 Z M 344.0 72.0 v 2.0 h -2.0 v -2.0 Z M 344.0 74.0 h 2.0 v 2.0 h -2.0 Z M 344.0 76.0 v 2.0 h -2.0 v -2.0 Z M 344.0 78.0 h 2.0 v 2.0 h -2.0 Z M 344.0 80.0 v 2.0 h -2.0 v -2.0 Z")
            )
            addPath(
                fill = SolidColor(Color.Black),
                fillAlpha = 0.2f,
                strokeAlpha = 0.2f,
                strokeLineWidth = 15f,
                pathData = addPathNodes("m 334.0 147.0 v 6.5 c 0.0 0.28 0.22 0.5 0.5 0.5 h 3.0 c 0.28 0.0 0.5 -0.22 0.5 -0.5 L 338.0 147.0 Z M 335.0 151.0 h 2.0 v 2.0 h -2.0 Z")
            )
            addPath(
                fill = SolidColor(Color(0xFFFAF8F6)),
                strokeLineWidth = 15f,
                pathData = addPathNodes("m 334.0 146.0 v 6.5 c 0.0 0.28 0.22 0.5 0.5 0.5 h 3.0 c 0.28 0.0 0.5 -0.22 0.5 -0.5 L 338.0 146.0 Z M 335.0 150.0 h 2.0 v 2.0 h -2.0 Z")
            )
            addPath(
                fill = SolidColor(Color(0xFFF1F0E9)),
                strokeLineWidth = 15f,
                pathData = addPathNodes("m 336.0 134.0 h 2.0 v 2.0 h -2.0 Z M 336.0 136.0 v 2.0 h -2.0 v -2.0 Z M 336.0 138.0 h 2.0 v 2.0 h -2.0 Z M 336.0 140.0 v 2.0 h -2.0 v -2.0 Z M 336.0 142.0 h 2.0 v 2.0 h -2.0 Z M 336.0 144.0 v 2.0 h -2.0 v -2.0 Z")
            )
            addPath(
                fill = SolidColor(Color.Black),
                fillAlpha = 0.2f,
                ...
                pathData = addPathNodes("m 327.0 243.5 v 2.75 c 0.0 0.14 0.11 0.25 0.25 0.25 h 1.5 c 0.14 0.0 0.25 -0.11 0.25 -0.25 v -2.75 Z M 327.5 245.0 h 1.0 v 1.0 h -1.0 Z")
            )
            addPath(
                fill = SolidColor(Color(0xFFFAF8F6)),
                strokeLineWidth = 15.000001f,
                pathData = addPathNodes("m 327.0 243.0 v 2.75 c 0.0 0.14 0.11 0.25 0.25 0.25 h 1.5 c 0.14 0.0 0.25 -0.11 0.25 -0.25 L 329.0 243.0 Z M 327.5 244.5 h 1.0 v 1.0 h -1.0 Z")
            )
            addPath(
                fill = SolidColor(Color(0xFFF1F0E9)),
                strokeLineWidth = 15.000001f,
                pathData = addPathNodes("m 328.0 237.0 h 1.0 v 1.0 h -1.0 Z M 328.0 238.0 v 1.0 h -1.0 v -1.0 Z M 328.0 239.0 h 1.0 v 1.0 h -1.0 Z M 328.0 240.0 v 1.0 h -1.0 v -1.0 Z M 328.0 241.0 h 1.0 v 1.0 h -1.0 Z M 328.0 242.0 v 1.0 h -1.0 v -1.0 Z")
            )
            addPath(
                fill = SolidColor(Color.Black),
                fillAlpha = 0.2f,
                strokeAlpha = 0.2f,
                strokeLineWidth = 15.000001f,
                pathData = addPathNodes("m 331.0 199.5 v 2.75 c 0.0 0.14 0.11 0.25 0.25 0.25 h 1.5 c 0.14 0.0 0.25 -0.11 0.25 -0.25 v -2.75 Z M 331.5 201.0 h 1.0 v 1.0 h -1.0 Z")
            )
            addPath(
                fill = SolidColor(Color(0xFFFAF8F6)),
                strokeLineWidth = 15.000001f,
                pathData = addPathNodes("m 331.0 199.0 v 2.75 c 0.0 0.14 0.11 0.25 0.25 0.25 h 1.5 c 0.14 0.0 0.25 -0.11 0.25 -0.25 L 333.0 199.0 Z M 331.5 200.5 h 1.0 v 1.0 h -1.0 Z")
            )
            addPath(
                fill = SolidColor(Color(0xFFF1F0E9)),
                strokeLineWidth = 15.000001f,
                pathData = addPathNodes("m 332.0 189.0 h 1.0 v 1.0 h -1.0 Z M 332.0 190.0 v 1.0 h -1.0 v -1.0 Z M 332.0 191.0 h 1.0 v 1.0 h -1.0 Z M 332.0 192.0 v 1.0 h -1.0 v -1.0 Z M 332.0 193.0 h 1.0 v 1.0 h -1.0 Z M 332.0 194.0 v 1.0 h -1.0 v -1.0 Z M 332.0 195.0 h 1.0 v 1.0 h -1.0 Z M 332.0 196.0 v 1.0 h -1.0 v -1.0 Z M 332.0 197.0 h 1.0 v 1.0 h -1.0 Z M 332.0 198.0 v 1.0 h -1.0 v -1.0 Z")
            )
            addPath(
                fill = SolidColor(Color(0xFFF1F0E9)),
                strokeLineWidth = 15f,
...
private var _FileRoller: ImageVector? = null
