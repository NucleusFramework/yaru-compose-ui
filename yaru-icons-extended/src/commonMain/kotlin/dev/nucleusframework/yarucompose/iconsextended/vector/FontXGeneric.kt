...
val FontXGeneric: ImageVector
    get() {
        if (_FontXGeneric != null) {
            return _FontXGeneric!!
        }
        _FontXGeneric = ImageVector.Builder(
            name = "FontXGeneric",
            defaultWidth = 400.dp,
            ...
            addPath(
                fill = Brush.linearGradient(
                    colorStops = arrayOf(
                        ...
                        1f to Color(0x002F5FDD)
                    ),
                    start = Offset(135.74f, 155.2f),
                    end = Offset(189.38f, 60.54f)
                ),
                fillAlpha = 0.5f,
                strokeAlpha = 0.5f,
                strokeLineWidth = 8f,
                pathData = addPathNodes("M 81.24 249.37 l 107.27 -189.32 l 1.74 0.99 l -107.27 189.32 Z")
            )
            addPath(
                fill = Brush.linearGradient(
                    colorStops = arrayOf(
                    ...
                    start = Offset(171.84f, 101f),
                    end = Offset(232f, 101f)
                ),
                fillAlpha = 0.5f,
                strokeAlpha = 0.5f,
                strokeLineWidth = 8f,
                pathData = addPathNodes("M 111.68 100.0 h 120.32 v 2.0 h -120.32 Z")
            )
            addPath(
                fill = Brush.linearGradient(
                    colorStops = arrayOf(
                    ...
                    start = Offset(152f, 173f),
                    end = Offset(232f, 173f)
                ),
                fillAlpha = 0.5f,
                strokeAlpha = 0.5f,
                strokeLineWidth = 8f,
                pathData = addPathNodes("M 72.0 172.0 h 160.0 v 2.0 h -160.0 Z")
            )
            addPath(
                fill = Brush.linearGradient(
                    colorStops = arrayOf(
                    ...
                    start = Offset(152f, 211f),
                    end = Offset(232f, 211f)
                ),
                fillAlpha = 0.5f,
                strokeAlpha = 0.5f,
                strokeLineWidth = 8f,
                pathData = addPathNodes("M 72.0 210.0 h 160.0 v 2.0 h -160.0 Z")
            )
            addPath(
                fill = Brush.linearGradient(
                    colorStops = arrayOf(
                    ...
                    start = Offset(185.34f, 148.8f),
                    end = Offset(200f, 240f)
                ),
                fillAlpha = 0.5f,
                strokeAlpha = 0.5f,
                strokeLineWidth = 8f,
                pathData = addPathNodes("M 170.77 67.78 L 206.89 255.45 l -1.96 0.38 L 168.87 68.53 Z")
            )
            addPath(
                fill = SolidColor(Color(0xFF2F5FDD)),
                strokeLineWidth = 0.49999994f,
                pathData = addPathNodes("m 134.24 171.97 h 40.44 l -9.99 -53.82 Z M 96.0 212.0 l 1.46 -7.95 h 9.58 L 165.72 100.0 h 12.29 l 19.31 104.05 h 10.68 L 206.54 212.0 h -39.72 l 1.46 -7.95 h 12.14 L 176.0 180.0 h -46.29 l -13.51 24.05 h 12.0 L 126.73 212.0 Z")
            )
            addPath(
                fill = SolidColor(Color(0xFF2F5FDD)),
                strokeLineWidth = 0.10714285f,
                pathData = addPathNodes("m 340.19 87.42 h 8.67 l -2.14 -11.53 Z M 332.0 96.0 l 0.31 -1.7 h 2.05 L 346.94 72.0 h 2.63 l 4.14 22.3 H 356.0 L 355.69 96.0 h -8.51 l 0.31 -1.7 h 2.6 l -0.95 -5.15 h -9.92 l -2.9 5.15 h 2.57 L 338.58 96.0 Z")
            )
            addPath(
                fill = SolidColor(Color(0xFF2F5FDD)),
                strokeLineWidth = 0.05357143f,
                pathData = addPathNodes("m 330.1 201.71 h 4.33 l -1.07 -5.77 Z M 326.0 206.0 l 0.16 -0.85 h 1.03 L 333.47 194.0 h 1.32 l 2.07 11.15 H 338.0 L 337.84 206.0 h -4.26 l 0.16 -0.85 h 1.3 l -0.47 -2.58 h -4.96 l -1.45 2.58 h 1.29 L 329.29 206.0 Z")
            )
            addPath(
                fill = SolidColor(Color(0xFF2F5FDD)),
                strokeLineWidth = 0.07142857f,
                pathData = addPathNodes("m 333.46 149.99 h 5.78 l -1.43 -7.39 Z M 328.0 156.03 l 0.21 -1.14 h 1.37 l 8.38 -14.9 h 1.76 l 2.76 14.9 H 344.0 l -0.21 1.14 h -5.67 l 0.21 -1.14 h 1.73 l -0.63 -3.76 h -6.61 l -1.93 3.76 h 1.71 l -0.21 1.14 Z")
            )
            addPath(
                fill = SolidColor(Color(0xFF2F5FDD)),
                strokeLineWidth = 0.03571428f,
                pathData = addPathNodes("m 326.73 245.14 h 2.89 l -0.71 -3.84 Z M 324.0 248.0 l 0.1 -0.57 h 0.68 L 328.98 240.0 h 0.88 l 1.38 7.43 H 332.0 L 331.9 248.0 h -2.84 l 0.1 -0.57 h 0.87 l -0.32 -1.72 h -3.31 l -0.97 1.72 h 0.86 L 326.19 248.0 Z")
            )
            addPath(
                fill = SolidColor(Color.White),
                fillAlpha = 0.1f,
                strokeAlpha = 0.1f,
                strokeLineWidth = 1f,
                pathData = addPathNodes("m 152.0 44.0 v 2.0 v 222.0 h 49.08 C 236.37 268.0 239.08 264.36 240.0 229.01 V 156.0 V 82.99 C 240.0 47.62 236.37 44.0 201.08 44.0 Z")
            )
            addPath(
                fill = SolidColor(Color.White),
                fillAlpha = 0.2f,
...
private var _FontXGeneric: ImageVector? = null
