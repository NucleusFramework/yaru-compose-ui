...
val ImageLoading: ImageVector
    get() {
        if (_ImageLoading != null) {
            return _ImageLoading!!
        }
        _ImageLoading = ImageVector.Builder(
            name = "ImageLoading",
            defaultWidth = 400.dp,
            ...
            addPath(
                ...
                pathData = addPathNodes("m 152.0 127.0 l 0.0 30.0 l 18.0 18.0")
            )
            addPath(
                ...
                pathData = addPathNodes("m 152.0 109.0 a 48.0 48.0 0.0 0 0 -48.0 48.0 a 48.0 48.0 0.0 0 0 48.0 48.0 a 48.0 48.0 0.0 0 0 48.0 -48.0 a 48.0 48.0 0.0 0 0 -48.0 -48.0 Z M 152.0 115.0 a 42.0 42.0 0.0 0 1 42.0 42.0 a 42.0 42.0 0.0 0 1 -42.0 42.0 a 42.0 42.0 0.0 0 1 -42.0 -42.0 a 42.0 42.0 0.0 0 1 42.0 -42.0 Z")
            )
            addPath(
                fillAlpha = 0.75f,
                stroke = SolidColor(Color(0xFF808080)),
                ...
                strokeLineWidth = 1f,
                pathFillType = PathFillType.EvenOdd,
                pathData = addPathNodes("m 336.0 143.63 l 0.0 4.37 l 2.62 2.62")
            )
            addPath(
                fill = SolidColor(Color(0xFF808080)),
                ...
                strokeLineCap = StrokeCap.Round,
                strokeLineJoin = StrokeJoin.Round,
                pathData = addPathNodes("m 336.0 141.0 a 7.0 7.0 0.0 0 0 -7.0 7.0 a 7.0 7.0 0.0 0 0 7.0 7.0 a 7.0 7.0 0.0 0 0 7.0 -7.0 a 7.0 7.0 0.0 0 0 -7.0 -7.0 Z M 336.0 141.88 a 6.12 6.12 0.0 0 1 6.12 6.12 a 6.12 6.12 0.0 0 1 -6.12 6.12 a 6.12 6.12 0.0 0 1 -6.12 -6.12 a 6.12 6.12 0.0 0 1 6.12 -6.12 Z")
            )
            addPath(
                fillAlpha = 0.5f,
                stroke = SolidColor(Color(0xFF808080)),
                ...
                strokeLineWidth = 1f,
                pathFillType = PathFillType.EvenOdd,
                pathData = addPathNodes("m 344.0 77.13 l 0.0 6.87 l 4.12 4.12")
            )
            addPath(
                fill = SolidColor(Color(0xFF808080)),
                strokeLineWidth = 5.5f,
                strokeLineCap = StrokeCap.Round,
                strokeLineJoin = StrokeJoin.Round,
                pathData = addPathNodes("m 344.0 73.0 a 11.0 11.0 0.0 0 0 -11.0 11.0 a 11.0 11.0 0.0 0 0 11.0 11.0 a 11.0 11.0 0.0 0 0 11.0 -11.0 a 11.0 11.0 0.0 0 0 -11.0 -11.0 Z M 344.0 74.38 a 9.62 9.62 0.0 0 1 9.62 9.62 a 9.62 9.62 0.0 0 1 -9.62 9.62 a 9.62 9.62 0.0 0 1 -9.62 -9.62 a 9.62 9.62 0.0 0 1 9.62 -9.62 Z")
            )
            addPath(
                fillAlpha = 0.75f,
                stroke = SolidColor(Color(0xFF808080)),
                ...
                strokeLineWidth = 1f,
                pathFillType = PathFillType.EvenOdd,
                pathData = addPathNodes("m 332.0 196.25 l 0.0 3.75 l 2.25 2.25")
            )
            addPath(
                fill = SolidColor(Color(0xFF808080)),
                strokeLineWidth = 3f,
                strokeLineCap = StrokeCap.Round,
                strokeLineJoin = StrokeJoin.Round,
                pathData = addPathNodes("m 332.0 194.0 a 6.0 6.0 0.0 0 0 -6.0 6.0 a 6.0 6.0 0.0 0 0 6.0 6.0 a 6.0 6.0 0.0 0 0 6.0 -6.0 a 6.0 6.0 0.0 0 0 -6.0 -6.0 Z M 332.0 194.75 a 5.25 5.25 0.0 0 1 5.25 5.25 a 5.25 5.25 0.0 0 1 -5.25 5.25 a 5.25 5.25 0.0 0 1 -5.25 -5.25 a 5.25 5.25 0.0 0 1 5.25 -5.25 Z")
            )
            addPath(
                fillAlpha = 0.75f,
                stroke = SolidColor(Color(0xFF808080)),
                ...
                strokeLineWidth = 1f,
                pathFillType = PathFillType.EvenOdd,
                pathData = addPathNodes("m 328.0 240.25 l 0.0 3.75 l 2.25 2.25")
            )
            addPath(
                fill = SolidColor(Color.White),
                fillAlpha = 0.1f,
...
private var _ImageLoading: ImageVector? = null
