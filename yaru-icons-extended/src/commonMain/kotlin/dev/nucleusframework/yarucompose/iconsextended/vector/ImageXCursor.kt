...
val ImageXCursor: ImageVector
    get() {
        if (_ImageXCursor != null) {
            return _ImageXCursor!!
        }
        _ImageXCursor = ImageVector.Builder(
            name = "ImageXCursor",
            defaultWidth = 400.dp,
            ...
            addPath(
                ...
                fillAlpha = 0.5f,
                strokeAlpha = 0.5f,
                strokeLineWidth = 11.9016f,
                pathFillType = PathFillType.EvenOdd,
                pathData = addPathNodes("m 128.0 108.63 v 83.31 l 18.64 -22.73 l 12.3 29.67 c 2.98 7.48 14.18 2.83 11.0 -4.56 L 157.37 164.0 l 26.06 0.06 Z")
            )
            addPath(
                fill = SolidColor(Color.Gray),
                fillAlpha = 0.5f,
                strokeAlpha = 0.5f,
                strokeLineWidth = 2.69731f,
                pathFillType = PathFillType.EvenOdd,
                pathData = addPathNodes("m 339.0 73.45 v 18.88 l 4.23 -5.15 l 2.79 6.72 c 0.67 1.69 3.21 0.64 2.49 -1.03 L 345.66 86.0 L 351.56 86.01 Z")
            )
            addPath(
                fill = SolidColor(Color.Gray),
                fillAlpha = 0.5f,
                strokeAlpha = 0.5f,
                strokeLineWidth = 1.69375f,
                pathFillType = PathFillType.EvenOdd,
                pathData = addPathNodes("m 333.01 141.12 v 11.86 l 2.65 -3.24 l 1.75 4.22 c 0.42 1.06 2.02 0.4 1.56 -0.65 l -1.79 -4.32 l 3.71 0.01 Z")
            )
            addPath(
                fill = SolidColor(Color.Gray),
                fillAlpha = 0.5f,
                strokeAlpha = 0.5f,
                strokeLineWidth = 1.44386f,
                pathFillType = PathFillType.EvenOdd,
                pathData = addPathNodes("m 329.0 194.28 v 10.11 l 2.26 -2.76 l 1.49 3.6 c 0.36 0.91 1.72 0.34 1.33 -0.55 L 332.56 201.0 l 3.16 0.01 Z")
            )
            addPath(
                fill = SolidColor(Color.Gray),
                fillAlpha = 0.5f,
                strokeAlpha = 0.5f,
                strokeLineWidth = 0.997157f,
                pathFillType = PathFillType.EvenOdd,
                pathData = addPathNodes("m 326.0 240.36 v 6.98 l 1.56 -1.9 l 1.03 2.49 c 0.25 0.63 1.19 0.24 0.92 -0.38 L 328.47 245.0 l 2.18 0.0 Z")
            )
            addPath(
                fill = SolidColor(Color.White),
                fillAlpha = 0.1f,
...
private var _ImageXCursor: ImageVector? = null
