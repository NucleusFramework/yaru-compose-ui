...
val InodeSymlink: ImageVector
    get() {
        if (_InodeSymlink != null) {
            return _InodeSymlink!!
        }
        _InodeSymlink = ImageVector.Builder(
            name = "InodeSymlink",
            defaultWidth = 400.dp,
            ...
            addPath(
                ...
                strokeLineWidth = 16.17552f,
                pathFillType = PathFillType.EvenOdd,
                pathData = addPathNodes("M 112.66 105.55 L 100.55 117.65 L 139.9 157.0 l -39.35 39.35 l 12.1 12.1 l 39.35 -39.35 l 39.34 39.35 l 12.1 -12.1 L 164.1 157.0 l 39.35 -39.35 l -12.1 -12.1 l -39.34 39.35 Z")
            )
            addPath(
                fill = SolidColor(Color(0xFFF22C42)),
                strokeLineWidth = 3.373642f,
                pathFillType = PathFillType.EvenOdd,
                pathData = addPathNodes("m 335.79 73.37 l -2.52 2.52 l 8.21 8.21 l -8.21 8.21 l 2.52 2.52 l 8.21 -8.21 l 8.2 8.21 l 2.52 -2.52 l -8.21 -8.21 l 8.21 -8.21 l -2.52 -2.52 l -8.2 8.21 Z")
            )
            addPath(
                fill = SolidColor(Color(0xFFF22C42)),
                strokeLineWidth = 2.1739728f,
                pathFillType = PathFillType.EvenOdd,
                pathData = addPathNodes("m 330.71 141.25 l -1.63 1.63 l 5.29 5.29 l -5.29 5.29 l 1.63 1.63 l 5.29 -5.29 l 5.29 5.29 l 1.63 -1.63 l -5.29 -5.29 l 5.29 -5.29 l -1.63 -1.63 l -5.29 5.29 Z")
            )
            addPath(
                fill = SolidColor(Color(0xFFF22C42)),
                strokeLineWidth = 1.4384874f,
                pathFillType = PathFillType.EvenOdd,
                pathData = addPathNodes("m 328.54 195.47 l -1.08 1.08 l 3.5 3.5 l -3.5 3.5 l 1.08 1.08 l 3.5 -3.5 l 3.5 3.5 l 1.08 -1.08 l -3.5 -3.5 l 3.5 -3.5 l -1.08 -1.08 l -3.5 3.5 Z")
            )
            addPath(
                fill = SolidColor(Color(0xFFF22C42)),
                strokeLineWidth = 1.3500624f,
                pathFillType = PathFillType.EvenOdd,
                pathData = addPathNodes("m 324.72 239.71 l -1.01 1.01 l 3.28 3.28 l -3.28 3.28 l 1.01 1.01 l 3.28 -3.28 l 3.28 3.28 l 1.01 -1.01 l -3.28 -3.28 l 3.28 -3.28 l -1.01 -1.01 l -3.28 3.28 Z")
            )
            addPath(
                fill = SolidColor(Color.White),
                fillAlpha = 0.1f,
...
private var _InodeSymlink: ImageVector? = null
