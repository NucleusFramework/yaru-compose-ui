...
val PreferencesSystemBluetooth: ImageVector
    get() {
        if (_PreferencesSystemBluetooth != null) {
            return _PreferencesSystemBluetooth!!
        }
        _PreferencesSystemBluetooth = ImageVector.Builder(
            name = "PreferencesSystemBluetooth",
            defaultWidth = 400.dp,
            ...
            addPath(
                ...
                strokeLineWidth = 1f,
                pathData = addPathNodes("m 324.1 237.0 c -2.81 0.0 -3.11 0.29 -3.1 3.1 V 244.0 v 3.9 c -0.01 2.81 0.29 3.1 3.1 3.1 h 5.81 c 2.81 0.0 3.1 -0.29 3.1 -3.1 V 244.0 V 240.1 c 0.0 -2.81 -0.29 -3.1 -3.1 -3.1 Z")
            )
            addPath(
                fill = Brush.linearGradient(
                    colorStops = arrayOf(
            ...
            addPath(
                ...
                strokeLineCap = StrokeCap.Square,
                pathFillType = PathFillType.EvenOdd,
                pathData = addPathNodes("m 325.51 245.71 l 4.0 -3.5 l -2.0 -2.0 v 7.5 l 2.0 -2.0 l -4.0 -3.5")
            )
            addPath(
                stroke = SolidColor(Color.White),
                strokeLineWidth = 1f,
            ...
            addPath(
                ...
                strokeAlpha = 0.1f,
                strokeLineWidth = 2f,
                pathData = addPathNodes("m 379.87 191.0 c -1.12 0.0 -2.02 0.02 -2.79 0.15 c -0.78 0.13 -1.48 0.39 -2.01 0.92 c -0.53 0.53 -0.79 1.24 -0.92 2.01 c -0.13 0.78 -0.15 1.67 -0.14 2.79 V 201.0 v 6.13 c -0.0 1.12 0.02 2.02 0.14 2.79 c 0.13 0.78 0.39 1.49 0.92 2.01 c 0.53 0.53 1.23 0.79 2.01 0.92 c 0.78 0.13 1.67 0.15 2.79 0.15 h 6.27 c 1.12 0.0 2.01 -0.02 2.79 -0.15 c 0.77 -0.13 1.48 -0.39 2.01 -0.92 c 0.53 -0.53 0.79 -1.23 0.92 -2.01 C 391.98 209.14 392.0 208.25 392.0 207.13 V 201.0 V 196.88 c 0.0 -1.12 -0.02 -2.02 -0.15 -2.79 c -0.13 -0.78 -0.39 -1.48 -0.92 -2.01 c -0.53 -0.53 -1.23 -0.79 -2.01 -0.92 C 388.15 191.02 387.25 191.0 386.13 191.0 Z")
            )
            addPath(
                fill = Brush.linearGradient(
                    colorStops = arrayOf(
                    ...
                    end = Offset(388.36f, 211.5f)
                ),
                strokeLineWidth = 1f,
                pathData = addPathNodes("m 379.64 190.5 c -4.66 0.0 -5.16 0.47 -5.14 5.1 v 4.4 v 6.4 c -0.02 4.62 0.48 5.1 5.14 5.1 h 6.73 c 4.66 0.0 5.14 -0.5 5.14 -5.1 v -6.4 v -4.4 c 0.0 -4.62 -0.48 -5.1 -5.14 -5.1 Z")
            )
            addPath(
                fill = SolidColor(Color.White),
                fillAlpha = 0.1f,
                strokeAlpha = 0.1f,
                strokeLineWidth = 2f,
                pathData = addPathNodes("m 383.0 190.5 v 21.0 h 3.37 c 4.66 0.0 5.13 -0.5 5.13 -5.1 V 200.0 V 195.6 c 0.0 -4.62 -0.48 -5.1 -5.13 -5.1 Z")
            )
            addPath(
                stroke = SolidColor(Color.White),
                strokeLineWidth = 1f,
                strokeLineCap = StrokeCap.Square,
                pathFillType = PathFillType.EvenOdd,
                pathData = addPathNodes("m 380.51 204.0 l 6.0 -5.5 l -3.0 -3.0 v 11.5 l 3.0 -3.0 l -6.0 -5.5")
            )
            addPath(
                fill = Brush.linearGradient(
                    colorStops = arrayOf(
                    ...
                    end = Offset(384f, 211f)
                ),
                fillAlpha = 0.7f,
                strokeAlpha = 0.7f,
                strokeLineWidth = 2f,
                pathData = addPathNodes("m 379.49 190.98 c -2.1 0.0 -3.21 0.16 -3.75 0.66 c -0.27 0.25 -0.46 0.62 -0.58 1.24 c -0.13 0.62 -0.18 1.47 -0.18 2.59 L 374.98 200.0 v 6.52 c 0.0 1.12 0.05 1.97 0.18 2.59 c 0.13 0.62 0.32 0.99 0.58 1.24 c 0.54 0.51 1.65 0.66 3.75 0.66 h 7.02 c 2.1 0.0 3.22 -0.16 3.76 -0.66 c 0.27 -0.25 0.46 -0.62 0.58 -1.24 c 0.13 -0.62 0.17 -1.47 0.17 -2.59 v -0.0 L 391.02 200.0 v -4.53 v -0.0 c 0.0 -1.12 -0.04 -1.97 -0.17 -2.59 c -0.13 -0.62 -0.31 -0.99 -0.58 -1.24 c -0.54 -0.51 -1.67 -0.66 -3.76 -0.66 Z M 379.87 192.0 h 6.27 c 1.09 0.0 1.9 0.03 2.46 0.13 c 0.55 0.09 0.79 0.22 0.92 0.36 c 0.14 0.14 0.27 0.37 0.36 0.93 c 0.09 0.55 0.13 1.37 0.13 2.46 v 4.13 v 6.13 c 0.0 1.9 -0.19 2.85 -0.52 3.22 c -0.33 0.37 -1.22 0.66 -3.35 0.66 h -6.27 c -1.09 0.0 -1.91 -0.03 -2.46 -0.13 c -0.55 -0.09 -0.79 -0.22 -0.93 -0.36 c -0.14 -0.14 -0.27 -0.37 -0.36 -0.93 c -0.09 -0.55 -0.12 -1.37 -0.12 -2.46 v -0.0 L 376.0 200.0 v -4.13 v -0.0 c -0.0 -1.09 0.03 -1.91 0.12 -2.46 c 0.09 -0.55 0.22 -0.79 0.36 -0.93 c 0.14 -0.14 0.38 -0.27 0.93 -0.36 c 0.55 -0.09 1.37 -0.13 2.46 -0.13 Z")
            )
            addPath(
                fill = SolidColor(Color.Black),
                fillAlpha = 0.4f,
                strokeAlpha = 0.4f,
                strokeLineWidth = 0.976529f,
                pathData = addPathNodes("m 379.49 190.0 c -2.13 0.0 -3.52 0.07 -4.42 0.93 c -0.45 0.43 -0.72 1.02 -0.87 1.76 C 374.05 193.43 374.0 194.33 374.0 195.48 L 374.0 200.0 v 6.52 c 0.0 1.14 0.05 2.05 0.2 2.79 c 0.15 0.74 0.42 1.33 0.87 1.76 c 0.91 0.86 2.29 0.93 4.42 0.93 h 7.02 c 2.13 0.0 3.52 -0.07 4.43 -0.93 c 0.45 -0.43 0.72 -1.02 0.87 -1.76 c 0.15 -0.74 0.19 -1.64 0.19 -2.79 v -0.0 L 392.0 200.0 v -4.52 v -0.0 c 0.01 -1.14 -0.04 -2.05 -0.19 -2.79 c -0.15 -0.74 -0.42 -1.33 -0.87 -1.76 C 390.03 190.07 388.64 190.0 386.51 190.0 Z M 379.49 190.98 h 7.02 c 2.1 0.0 3.22 0.16 3.76 0.66 c 0.27 0.25 0.46 0.62 0.58 1.24 c 0.13 0.62 0.17 1.47 0.17 2.59 v 0.0 v 4.53 v 6.53 v 0.0 c 0.0 1.12 -0.04 1.97 -0.17 2.59 c -0.13 0.62 -0.31 0.99 -0.58 1.24 c -0.54 0.51 -1.67 0.66 -3.76 0.66 h -7.02 c -2.1 0.0 -3.21 -0.16 -3.75 -0.66 c -0.27 -0.25 -0.46 -0.62 -0.58 -1.24 c -0.13 -0.62 -0.18 -1.47 -0.18 -2.59 L 374.98 200.0 L 374.98 195.48 c 0.0 -1.12 0.05 -1.97 0.18 -2.59 c 0.13 -0.62 0.32 -0.99 0.58 -1.24 c 0.54 -0.51 1.65 -0.66 3.75 -0.66 Z")
            )
            addPath(
                fillAlpha = 0.4f,
                stroke = SolidColor(Color.Black),
...
private var _PreferencesSystemBluetooth: ImageVector? = null
