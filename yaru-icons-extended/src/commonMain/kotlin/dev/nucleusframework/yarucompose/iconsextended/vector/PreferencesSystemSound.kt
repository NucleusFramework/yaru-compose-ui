...
val PreferencesSystemSound: ImageVector
    get() {
        if (_PreferencesSystemSound != null) {
            return _PreferencesSystemSound!!
        }
        _PreferencesSystemSound = ImageVector.Builder(
            name = "PreferencesSystemSound",
            defaultWidth = 400.dp,
            ...
            addPath(
                ...
                strokeLineWidth = 0.0153034f,
                pathData = addPathNodes("M 152.0 84.0 L 152.0 84.0 A 72.0 72.0 0.0 0 1 224.0 156.0 L 224.0 156.0 A 72.0 72.0 0.0 0 1 152.0 228.0 L 152.0 228.0 A 72.0 72.0 0.0 0 1 80.0 156.0 L 80.0 156.0 A 72.0 72.0 0.0 0 1 152.0 84.0 Z")
            )
            addPath(
                fill = SolidColor(Color(0xFF191622)),
                strokeLineWidth = 0.01562222f,
                pathData = addPathNodes("M 89.0 156.0 a 63.0 63.0 89.96 1 0 126.0 0.0 a 63.0 63.0 89.96 1 0 -126.0 0.0 Z")
            )
            addPath(
                fill = SolidColor(Color(0xFF4D4D4D)),
                strokeLineWidth = 0.01445514f,
                pathData = addPathNodes("M 98.0 156.0 a 54.0 54.0 90.0 1 0 108.0 0.0 a 54.0 54.0 90.0 1 0 -108.0 0.0 Z")
            )
            addPath(
                fill = Brush.radialGradient(
                    colorStops = arrayOf(
                        0f to Color(0xFFFEE581),
                        1f to Color(0xFFEAB305)
                    ),
                    center = Offset(153.83f, 202.95f),
                    radius = 86.36f
                ),
                strokeLineWidth = 0.0147368f,
                pathData = addPathNodes("M 104.14 169.03 a 49.53 49.52 75.0 1 0 95.67 -25.64 a 49.53 49.52 75.0 1 0 -95.67 25.64 Z")
            )
            addPath(
                fill = SolidColor(Color.Black),
                strokeLineWidth = 0.01489457f,
                pathData = addPathNodes("M 129.45 156.21 a 22.53 22.52 89.99 1 0 45.05 0.0 a 22.53 22.52 89.99 1 0 -45.05 0.0 Z")
            )
            addPath(
                fill = Brush.radialGradient(
                    colorStops = arrayOf(
                        0f to Color(0xFF4D4D4D),
                        0.57f to Color(0xFF333333),
                        1f to Color(0xFF1A1A1A)
                    ),
                    center = Offset(151.98f, 149.54f),
                    radius = 23.2f
                ),
                strokeLineWidth = 0.01532419f,
                pathData = addPathNodes("M 134.57 160.88 a 18.03 18.02 75.03 1 0 34.82 -9.33 a 18.03 18.02 75.03 1 0 -34.82 9.33 Z")
            )
            addPath(
                fill = SolidColor(Color(0xFF4D4D4D)),
                strokeLineWidth = 0.01291224f,
                pathData = addPathNodes("M 343.93 68.54 L 343.93 68.54 A 16.0 16.0 0.0 0 1 359.93 84.54 L 359.93 84.54 A 16.0 16.0 0.0 0 1 343.93 100.54 L 343.93 100.54 A 16.0 16.0 0.0 0 1 327.93 84.54 L 327.93 84.54 A 16.0 16.0 0.0 0 1 343.93 68.54 Z")
            )
            addPath(
                fill = SolidColor(Color(0xFF191622)),
                strokeLineWidth = 0.01318124f,
                pathData = addPathNodes("M 329.93 84.54 a 14.0 14.0 89.96 1 0 28.0 0.0 a 14.0 14.0 89.96 1 0 -28.0 0.0 Z")
            )
            addPath(
                fill = SolidColor(Color(0xFF4D4D4D)),
                strokeLineWidth = 0.01219653f,
                pathData = addPathNodes("M 331.93 84.54 a 12.0 12.0 90.0 1 0 24.0 0.0 a 12.0 12.0 90.0 1 0 -24.0 0.0 Z")
            )
            addPath(
                fill = Brush.radialGradient(
                    colorStops = arrayOf(
                    ...
                    center = Offset(344.33f, 94.97f),
                    radius = 19.19f
                ),
                strokeLineWidth = 0.01243418f,
                pathData = addPathNodes("M 333.29 87.43 a 11.01 11.01 75.0 1 0 21.26 -5.7 a 11.01 11.01 75.0 1 0 -21.26 5.7 Z")
            )
            addPath(
                fill = SolidColor(Color.Black),
                strokeLineWidth = 0.01256728f,
                pathData = addPathNodes("M 338.92 84.58 a 5.01 5.01 89.99 1 0 10.01 0.0 a 5.01 5.01 89.99 1 0 -10.01 0.0 Z")
            )
            addPath(
                fill = Brush.radialGradient(
                    colorStops = arrayOf(
                    ...
                    center = Offset(343.92f, 83.1f),
                    radius = 5.16f
                ),
                strokeLineWidth = 0.01292979f,
                pathData = addPathNodes("M 340.05 85.62 a 4.01 4.01 75.03 1 0 7.74 -2.07 a 4.01 4.01 75.03 1 0 -7.74 2.07 Z")
            )
            addPath(
                fill = SolidColor(Color(0xFF4D4D4D)),
                strokeLineWidth = 0.01291224f,
                pathData = addPathNodes("M 335.95 137.69 L 335.95 137.69 A 10.67 10.67 0.0 0 1 346.62 148.36 L 346.62 148.36 A 10.67 10.67 0.0 0 1 335.95 159.02 L 335.95 159.02 A 10.67 10.67 0.0 0 1 325.28 148.36 L 325.28 148.36 A 10.67 10.67 0.0 0 1 335.95 137.69 Z")
            )
            addPath(
                fill = SolidColor(Color(0xFF191622)),
                strokeLineWidth = 0.01318124f,
                pathData = addPathNodes("M 326.62 148.36 a 9.33 9.33 89.96 1 0 18.67 0.0 a 9.33 9.33 89.96 1 0 -18.67 0.0 Z")
            )
            addPath(
                fill = SolidColor(Color(0xFF4D4D4D)),
                strokeLineWidth = 0.01219653f,
                pathData = addPathNodes("M 327.95 148.36 a 8.0 8.0 90.0 1 0 16.0 0.0 a 8.0 8.0 90.0 1 0 -16.0 0.0 Z")
            )
            addPath(
                fill = Brush.radialGradient(
                    colorStops = arrayOf(
                    ...
                    center = Offset(336.22f, 155.31f),
                    radius = 12.79f
                ),
                strokeLineWidth = 0.01243418f,
                pathData = addPathNodes("M 328.86 150.29 a 7.34 7.34 75.0 1 0 14.17 -3.8 a 7.34 7.34 75.0 1 0 -14.17 3.8 Z")
            )
            addPath(
                fill = SolidColor(Color.Black),
                strokeLineWidth = 0.01256728f,
                pathData = addPathNodes("M 332.61 148.39 a 3.34 3.34 89.99 1 0 6.67 0.0 a 3.34 3.34 89.99 1 0 -6.67 0.0 Z")
            )
            addPath(
                fill = Brush.radialGradient(
                    colorStops = arrayOf(
                    ...
                    center = Offset(335.95f, 147.4f),
                    radius = 3.44f
                ),
                strokeLineWidth = 0.01292979f,
                pathData = addPathNodes("M 333.37 149.08 a 2.67 2.67 75.03 1 0 5.16 -1.38 a 2.67 2.67 75.03 1 0 -5.16 1.38 Z")
            )
            addPath(
                fill = SolidColor(Color(0xFF4D4D4D)),
                strokeLineWidth = 0.01291224f,
                pathData = addPathNodes("M 331.96 192.27 L 331.96 192.27 A 8.0 8.0 0.0 0 1 339.96 200.27 L 339.96 200.27 A 8.0 8.0 0.0 0 1 331.96 208.27 L 331.96 208.27 A 8.0 8.0 0.0 0 1 323.96 200.27 L 323.96 200.27 A 8.0 8.0 0.0 0 1 331.96 192.27 Z")
            )
            addPath(
                fill = SolidColor(Color(0xFF191622)),
                strokeLineWidth = 0.01318124f,
                pathData = addPathNodes("M 324.96 200.27 a 7.0 7.0 89.96 1 0 14.0 0.0 a 7.0 7.0 89.96 1 0 -14.0 0.0 Z")
            )
            addPath(
                fill = SolidColor(Color(0xFF4D4D4D)),
                strokeLineWidth = 0.01219653f,
                pathData = addPathNodes("M 325.96 200.27 a 6.0 6.0 90.0 1 0 12.0 0.0 a 6.0 6.0 90.0 1 0 -12.0 0.0 Z")
            )
            addPath(
                fill = Brush.radialGradient(
                    colorStops = arrayOf(
                    ...
                    center = Offset(332.17f, 205.48f),
                    radius = 9.6f
                ),
                strokeLineWidth = 0.01243418f,
                pathData = addPathNodes("M 326.65 201.72 a 5.5 5.5 75.0 1 0 10.63 -2.85 a 5.5 5.5 75.0 1 0 -10.63 2.85 Z")
            )
            addPath(
                fill = SolidColor(Color.Black),
                strokeLineWidth = 0.01256728f,
                pathData = addPathNodes("M 329.46 200.29 a 2.5 2.5 89.99 1 0 5.01 0.0 a 2.5 2.5 89.99 1 0 -5.01 0.0 Z")
            )
            addPath(
                fill = Brush.radialGradient(
                    colorStops = arrayOf(
                    ...
                    center = Offset(331.96f, 199.55f),
                    radius = 2.58f
                ),
                strokeLineWidth = 0.01292979f,
                pathData = addPathNodes("M 330.03 200.81 a 2.0 2.0 75.03 1 0 3.87 -1.04 a 2.0 2.0 75.03 1 0 -3.87 1.04 Z")
            )
            addPath(
                fill = SolidColor(Color(0xFF4D4D4D)),
                strokeLineWidth = 0.01291224f,
                pathData = addPathNodes("M 327.98 238.85 L 327.98 238.85 A 5.33 5.33 0.0 0 1 333.31 244.18 L 333.31 244.18 A 5.33 5.33 0.0 0 1 327.98 249.51 L 327.98 249.51 A 5.33 5.33 0.0 0 1 322.64 244.18 L 322.64 244.18 A 5.33 5.33 0.0 0 1 327.98 238.85 Z")
            )
            addPath(
                fill = SolidColor(Color(0xFF191622)),
                strokeLineWidth = 0.01318124f,
                pathData = addPathNodes("M 323.31 244.18 a 4.67 4.67 89.96 1 0 9.33 0.0 a 4.67 4.67 89.96 1 0 -9.33 0.0 Z")
            )
            addPath(
                fill = SolidColor(Color(0xFF4D4D4D)),
                strokeLineWidth = 0.01219653f,
                pathData = addPathNodes("M 323.98 244.18 a 4.0 4.0 90.0 1 0 8.0 0.0 a 4.0 4.0 90.0 1 0 -8.0 0.0 Z")
            )
            addPath(
                fill = Brush.radialGradient(
                    colorStops = arrayOf(
                    ...
                    center = Offset(328.11f, 247.66f),
                    radius = 6.4f
                ),
                strokeLineWidth = 0.01243418f,
                pathData = addPathNodes("M 324.43 245.14 a 3.67 3.67 75.0 1 0 7.09 -1.9 a 3.67 3.67 75.0 1 0 -7.09 1.9 Z")
            )
            addPath(
                fill = SolidColor(Color.Black),
                strokeLineWidth = 0.01256728f,
                pathData = addPathNodes("M 326.31 244.19 a 1.67 1.67 89.99 1 0 3.34 0.0 a 1.67 1.67 89.99 1 0 -3.34 0.0 Z")
            )
            addPath(
                fill = Brush.radialGradient(
                    colorStops = arrayOf(
                    ...
                    center = Offset(327.97f, 243.7f),
                    radius = 1.72f
                ),
                strokeLineWidth = 0.01292979f,
                pathData = addPathNodes("M 326.68 244.54 a 1.34 1.34 75.03 1 0 2.58 -0.69 a 1.34 1.34 75.03 1 0 -2.58 0.69 Z")
            )
            addPath(
...
private var _PreferencesSystemSound: ImageVector? = null
