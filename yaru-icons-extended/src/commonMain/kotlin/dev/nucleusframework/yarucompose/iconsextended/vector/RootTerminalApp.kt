...
val RootTerminalApp: ImageVector
    get() {
        if (_RootTerminalApp != null) {
            return _RootTerminalApp!!
        }
        _RootTerminalApp = ImageVector.Builder(
            name = "RootTerminalApp",
            defaultWidth = 400.dp,
            ...
            addPath(
                ...
                strokeAlpha = 0.3f,
                strokeLineWidth = 1f,
                pathData = addPathNodes("M 78.99 68.0 C 43.62 68.0 40.0 71.62 40.0 106.92 L 40.0 205.08 C 40.0 205.16 40.0 205.24 40.0 205.33 L 40.0 108.92 C 40.0 73.62 43.63 69.99 78.99 69.99 L 152.0 69.99 L 225.01 69.99 C 260.29 69.99 263.98 73.62 264.0 108.67 L 264.0 106.92 C 264.0 71.62 260.37 68.0 225.0 68.0 L 152.0 68.0 L 78.99 68.0 Z")
            )
            addPath(
                fill = SolidColor(Color.Black),
                fillAlpha = 0.2f,
                strokeAlpha = 0.2f,
                strokeLineWidth = 1f,
                pathData = addPathNodes("M 40.0 203.08 L 40.0 205.08 C 40.0 240.37 43.62 244.17 78.99 244.0 L 152.0 244.0 L 225.0 244.0 C 260.37 244.17 264.0 240.37 264.0 205.08 L 264.0 203.08 C 264.0 238.37 260.37 242.17 225.0 242.0 L 152.0 242.0 L 78.99 242.0 C 43.62 242.17 40.0 238.37 40.0 203.08 Z")
            )
            addPath(
                fillAlpha = 0.4f,
                stroke = SolidColor(Color.Black),
            ...
            addPath(
                ...
                strokeAlpha = 0.05f,
                strokeLineWidth = 1f,
                pathData = addPathNodes("M 40.0 148.0 L 40.0 205.08 C 40.0 240.37 43.62 244.17 78.99 244.0 L 152.0 244.0 L 225.0 244.0 C 260.37 244.17 264.0 240.37 264.0 205.08 L 264.0 148.0 L 40.0 148.0 Z")
            )
            addPath(
                fill = Brush.linearGradient(
                    colorStops = arrayOf(
            ...
            addPath(
                ...
                strokeAlpha = 0.2f,
                strokeLineWidth = 1f,
                pathData = addPathNodes("m 328.53 72.19 l -0.48 1.45 l 4.89 1.96 l -4.89 1.96 l 0.48 1.45 l 6.29 -2.66 L 334.82 74.86 Z M 335.0 81.0 v 1.48 h 7.48 v -1.48 Z")
            )
            addPath(
                fill = SolidColor(Color.White),
                strokeLineWidth = 1f,
            ...
            addPath(
                fill = SolidColor(Color(0xFFF2F2F2)),
                strokeLineWidth = 1f,
                pathData = addPathNodes("m 328.53 71.19 l -0.48 1.45 l 4.89 1.96 l -4.89 1.96 l 0.48 1.45 l 6.29 -2.66 L 334.82 73.86 Z M 335.0 80.0 v 1.48 h 7.48 v -1.48 Z")
            )
            addPath(
                fill = SolidColor(Color(0xFFF2F2F2)),
                strokeLineWidth = 1f,
...
private var _RootTerminalApp: ImageVector? = null
