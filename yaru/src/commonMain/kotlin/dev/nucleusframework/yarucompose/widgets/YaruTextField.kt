    ...
    Row(
        ...
        Box(modifier = Modifier.weight(1f), contentAlignment = Alignment.CenterStart) {
            BasicTextField(
                ...
                // Without an explicit width the BasicTextField wraps its
                // content (~10 chars when empty), so the I-beam hover icon and
                // click-to-caret only cover the left part of the field —
                // `fillMaxWidth` extends both to the whole decorated area.
    ...
    Row(
        ...
        Box(modifier = Modifier.weight(1f), contentAlignment = Alignment.CenterStart) {
            BasicTextField(
                ...
                keyboardActions = keyboardActions,
                interactionSource = interactionSource,
                // See the String overload — full-width input keeps the I-beam
                // hover icon and click-to-caret active across the whole field.
                modifier = Modifier.fillMaxWidth(),
            )
